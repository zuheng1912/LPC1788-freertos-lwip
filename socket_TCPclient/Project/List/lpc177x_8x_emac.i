#line 1 "..\\..\\Drivers\\source\\lpc177x_8x_emac.c"
...
#line 36 "..\\..\\Drivers\\source\\lpc177x_8x_emac.c"



#line 1 "..\\..\\Drivers\\include\\lpc177x_8x_emac.h"
...
#line 43 "..\\..\\Drivers\\include\\lpc177x_8x_emac.h"
#line 44 "..\\..\\Drivers\\include\\lpc177x_8x_emac.h"
...
#line 69 "..\\..\\Drivers\\include\\lpc177x_8x_emac.h"

 
#line 85 "..\\..\\Drivers\\include\\lpc177x_8x_emac.h"
...
#line 188 "..\\..\\Drivers\\include\\lpc177x_8x_emac.h"
...
#line 241 "..\\..\\Drivers\\include\\lpc177x_8x_emac.h"
...
#line 263 "..\\..\\Drivers\\include\\lpc177x_8x_emac.h"
...
#line 282 "..\\..\\Drivers\\include\\lpc177x_8x_emac.h"

 
#line 293 "..\\..\\Drivers\\include\\lpc177x_8x_emac.h"
...
#line 313 "..\\..\\Drivers\\include\\lpc177x_8x_emac.h"
...
#line 334 "..\\..\\Drivers\\include\\lpc177x_8x_emac.h"
...
#line 389 "..\\..\\Drivers\\include\\lpc177x_8x_emac.h"
...
#line 402 "..\\..\\Drivers\\include\\lpc177x_8x_emac.h"

 
#line 412 "..\\..\\Drivers\\include\\lpc177x_8x_emac.h"
...
#line 472 "..\\..\\Drivers\\include\\lpc177x_8x_emac.h"
...
typedef struct {
    EMAC_PHY_CFG_Type PhyCfg;                
    uint8_t           bPhyAddr;                     	
    uint8_t 	*pbEMAC_Addr;				

 
    uint16_t     nMaxFrameSize;               
    PHY_INIT_FUNC *pfnPHYInit;                
    PHY_RESET_FUNC *pfnPHYReset;              
    EMAC_FRAME_RECV_FUNC *pfnFrameReceive;      
    EMAC_TRANSMIT_FINISH_FUNC* pfnTransmitFinish;   
    EMAC_ERR_RECV_FUNC    *pfnErrorReceive;      
    ...
    EMAC_WAKEUP_FUNC *pfnWakeup;                
    SOFT_INT_FUNC *pfnSoftInt;				   					   
} EMAC_CFG_Type;
...
#line 40 "..\\..\\Drivers\\source\\lpc177x_8x_emac.c"
...
#line 41 "..\\..\\Drivers\\source\\lpc177x_8x_emac.c"
#line 1 "..\\..\\Drivers\\include\\lpc177x_8x_pinsel.h"
...
#line 38 "..\\..\\Drivers\\include\\lpc177x_8x_pinsel.h"
#line 39 "..\\..\\Drivers\\include\\lpc177x_8x_pinsel.h"
...
#line 59 "..\\..\\Drivers\\include\\lpc177x_8x_pinsel.h"


 
#line 201 "..\\..\\Drivers\\include\\lpc177x_8x_pinsel.h"
...
#line 42 "..\\..\\Drivers\\source\\lpc177x_8x_emac.c"
...
static uint16_t __attribute__ ((aligned (4))) saFrameBuffers[(2)][(0x600)];
...
void rx_descr_init (void)
{
	...
	for (i = 0; i < 4; i++)
	{
		(*(uint32_t *)((0x20000000UL) + 8*i))  = ((((((0x20000000UL) + 4*8) + 4*8) + 3*8) + 3*4) + 1536*i);
		(*(uint32_t *)((0x20000000UL)+4 + 8*i))    = 0x80000000 | (1536-1);
		(*(uint32_t *)(((0x20000000UL) + 4*8) + 8*i))    = 0;
		(*(uint32_t *)(((0x20000000UL) + 4*8)+4 + 8*i)) = 0;
	}

	 
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->RxDescriptor    = (0x20000000UL);
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->RxStatus        = ((0x20000000UL) + 4*8);
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->RxDescriptorNumber = 4-1;

	 
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->RxConsumeIndex  = 0;
}
...
void tx_descr_init (void)
{
	...
	for (i = 0; i < 3; i++)
	{
		(*(uint32_t *)((((0x20000000UL) + 4*8) + 4*8) + 8*i)) = (((((((0x20000000UL) + 4*8) + 4*8) + 3*8) + 3*4) + 4*1536) + 1536*i);
		(*(uint32_t *)((((0x20000000UL) + 4*8) + 4*8)+4 + 8*i))   = 0;
		(*(uint32_t *)(((((0x20000000UL) + 4*8) + 4*8) + 3*8) + 4*i))   = 0;
	}

	 
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->TxDescriptor    = (((0x20000000UL) + 4*8) + 4*8);
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->TxStatus        = ((((0x20000000UL) + 4*8) + 4*8) + 3*8);
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->TxDescriptorNumber = 3-1;

	 
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->TxProduceIndex  = 0;
}
...
void setEmacAddr(uint8_t abStationAddr[])
{
	...
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->SA0 = ((uint32_t)abStationAddr[5] << 8) | (uint32_t)abStationAddr[4];
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->SA1 = ((uint32_t)abStationAddr[3] << 8) | (uint32_t)abStationAddr[2];
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->SA2 = ((uint32_t)abStationAddr[1] << 8) | (uint32_t)abStationAddr[0];
}
...
void EMAC_Write_PHY (uint8_t PhyReg, uint16_t Value)
{
	...
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->MADR = ((EMAC_Configs.bPhyAddr & 0x1F) << 8 )| (PhyReg & 0x1F);
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->MWTD = Value;
	...
	{
		if ((((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->MIND & 0x00000001) == 0)
		{
			break;
		}
	}
...
uint16_t EMAC_Read_PHY (uint8_t PhyReg)
{
	...
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->MADR = ((EMAC_Configs.bPhyAddr & 0x1F) << 8 )| (PhyReg & 0x1F);
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->MCMD = 0x00000001;
	...
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->MCMD = 0;
	return (((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->MRDD);
}
...
void EMAC_SetFullDuplexMode(uint8_t full_duplex)
{
  if(full_duplex)
  {
        ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->MAC2    |= 0x00000001;
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->Command |= 0x00000400;
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->IPGT     = ((0x15&0x7F));
  }
  else
  {
        ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->IPGT = ((0x12&0x7F));
  }
}
...
void EMAC_SetPHYSpeed(uint8_t mode_100Mbps)
{
  if(mode_100Mbps)
  {
     ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->SUPP = 0x00000100;
  }
  else
  {
     ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->SUPP = 0;
  }
}
...
int32_t EMAC_Init(EMAC_CFG_Type *EMAC_ConfigStruct)
{
	...
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->MAC1    = 0x00000100 | 0x00000200 | 0x00000400 |
					0x00000800 | 0x00004000 | 0x00008000;

	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->Command = 0x00000008 | 0x00000010 | 0x00000020 | 0x00000040;

	 
	for (tout = 100; tout; tout--);

	 
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->MAC1 = 0x00000002;
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->MAC2 = 0x00000010 | 0x00000020;
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->MAXF = 1536;
	

 
	tmp = CLKPWR_GetCLK(((uint32_t)(0)))/ 2500000UL;
	...
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->MAXF = EMAC_ConfigStruct->nMaxFrameSize;

	
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->MCFG = ((tout&0x0F)<<2) | 0x00008000;

	
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->MCFG &= ~(0x00008000);
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->CLRT = (((0x0F&0x0F))|(((0x37&0x3F)<<8)));
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->IPGR = ((0x12&0x7F));

	 
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->Command = 0x00000200 | 0x00000040;


	
	if(EMAC_ConfigStruct->pfnPHYInit != ((void*) 0))
	{
	...
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->RxFilterCtrl = 0x00000004 | 0x00000002 | 0x00000020;

	 
	EMAC_IntCmd((0x00000001 | 0x00000002 | 0x00000004 			| 0x00000008 | 0x00000010 | 0x00000020 			| 0x00000040 | 0x00000080), ENABLE);



	 
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->IntClear  = 0xFFFF;
...
void EMAC_DeInit(void)
{
	...
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->IntEnable = 0x00;

	
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->IntClear = (0xFF) | (0x00001000 | 0x00002000);

	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->Command = 0;
...
void EMAC_TxEnable( void )
{
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->Command |= 0x00000002;
	return;
}
...
void EMAC_RxEnable( void )
{
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->Command |= 0x00000001;
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->MAC1 |= 0x00000001;
	return;
}
...
EMAC_BUFF_STATUS EMAC_GetBufferSts(EMAC_BUFF_IDX idx)
{
    ...
    if(idx == EMAC_TX_BUFF)
    {
        consume_idx = ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->TxConsumeIndex;
        produce_idx = ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->TxProduceIndex;
        max_frag_num = ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->TxDescriptorNumber + 1;
    }
    else
    {
        consume_idx = ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->RxConsumeIndex;
        produce_idx = ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->RxProduceIndex;
        max_frag_num = ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->RxDescriptorNumber + 1;
    }
 ...
 uint32_t EMAC_AllocTxBuff(uint16_t nFrameSize, uint8_t bLastFrame)
{
    ...
    idx = ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->TxProduceIndex;
    ...
    dp = (*(uint32_t *)((((0x20000000UL) + 4*8) + 4*8) + 8*idx));

    if(bLastFrame)
      (*(uint32_t *)((((0x20000000UL) + 4*8) + 4*8)+4 + 8*idx)) = ((nFrameSize-1) & 0x000007FF) | (0x80000000 | 0x40000000);
    else
      (*(uint32_t *)((((0x20000000UL) + 4*8) + 4*8)+4 + 8*idx)) = ((nFrameSize-1) & 0x000007FF) | (0x80000000);
...
void EMAC_UpdateTxProduceIndex(void)
{
	...
	uint32_t idx = ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->TxProduceIndex;

	 
	if (++idx == ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->TxDescriptorNumber + 1) idx = 0;
	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->TxProduceIndex = idx;
}
...
uint32_t EMAC_GetTxFrameStatus(void)
{
	...
	idx = ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->TxProduceIndex;
	return ((*(uint32_t *)(((((0x20000000UL) + 4*8) + 4*8) + 3*8) + 4*idx)));
}
...
void EMAC_WritePacketBuffer(EMAC_PACKETBUF_Type *pDataStruct)
{
   ...
   int32_t  frame_num;
   uint32_t tmp;
   uint32_t max_frame_size = ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->MAXF;
   ...
   while(frame_num >= 0)
   {
     ...
     if(frame_num == 0)
       pDest = (uint16_t*)EMAC_AllocTxBuff(tmp, 1);  
     else
...
uint32_t EMAC_GetRxFrameStatus(void)
{
	...
	idx = ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->RxConsumeIndex;
	return ((*(uint32_t *)(((0x20000000UL) + 4*8) + 8*idx)));
}
...
uint32_t EMAC_GetRxFrameSize(void)
{
	...
	return ((((*(uint32_t *)(((0x20000000UL) + 4*8) + 8*idx))) & 0x000007FF)+1);
}
...
uint32_t EMAC_GetRxBuffer(void)
{
	...
	idx = ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->RxConsumeIndex;
  	...
  	return (*(uint32_t *)((0x20000000UL) + 8*idx));
 }
...
void EMAC_UpdateRxConsumeIndex(void)
{
	...
	uint32_t idx = ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->RxConsumeIndex;

	 
	if (++idx == 4) idx = 0;

	((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->RxConsumeIndex = idx;
}
...
void ENET_IRQHandler(void)
{
	...
	while ((int_stat = (((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->IntStatus & ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->IntEnable)) != 0)
	{
		
		((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->IntClear = int_stat;
	 
	    if(int_stat & (0x00000001 |0x00000002 ))
		{
		   uint32_t ulFrameSts = EMAC_GetRxFrameStatus();
		   uint32_t ulErrCode = 0;

		   ulErrCode |= (ulFrameSts & 0x00800000) ? ( 1 << 4):0;
		   ulErrCode |= (ulFrameSts & 0x01000000) ? ( 1 << 3):0;
		   ulErrCode |= (ulFrameSts & 0x02000000) ? ( 1 << 2):0;
		   ulErrCode |= (ulFrameSts & 0x08000000) ? ( 1 << 0):0;
		   ulErrCode |= (ulFrameSts & 0x10000000) ? ( 1 << 6):0;
		   ulErrCode |= (ulFrameSts & 0x20000000) ? ( 1 << 5):0;
		   ulErrCode |= (ulFrameSts & 0x00100000) ? ( 1 << 12):0;
		   ...
		   {
		     if(EMAC_Configs.pfnErrorReceive != ((void*) 0))
		       EMAC_Configs.pfnErrorReceive(ulErrCode);
		   	}
		}

		if(int_stat & (0x00000010|0x00000020 ))
		{
		   uint32_t ulFrameSts = EMAC_GetTxFrameStatus();
		   uint32_t ulErrCode = 0;

		   ulErrCode |= (ulFrameSts & 0x04000000) ? ( 1 << 9):0;
		   ulErrCode |= (ulFrameSts & 0x08000000) ? ( 1 << 8):0;
		   ulErrCode |= (ulFrameSts & 0x10000000) ? ( 1 << 7):0;
		   ulErrCode |= (ulFrameSts & 0x20000000) ? ( 1 << 10):0;
		   ulErrCode |= (ulFrameSts & 0x40000000) ? ( 1 << 11):0;
		   if(EMAC_Configs.pfnErrorReceive != ((void*) 0))
		      EMAC_Configs.pfnErrorReceive(ulErrCode);
		}
	    ...
	    if(int_stat & 0x00000008)
	    {
		 ...
		 if(RxLen > 0)
		 {
		    ...
		    if((EMAC_GetRxFrameStatus() & (0x00100000 | 0x00800000 | 0x01000000 | 0x02000000 | 0x08000000 | 0x10000000) )== 0)
                    {
			...
			if(sulCurrFrameSz >= (0x600))
			{
			  sulCurrFrameSz = 0;
			  if(EMAC_Configs.pfnErrorReceive != ((void*) 0))
		             EMAC_Configs.pfnErrorReceive(( 1 << 2));
			}
			else
			{
			   ...
			   while (RxLen > 0)
			    ...
			    if(EMAC_GetRxFrameStatus() & 0x40000000)
			    {
				  
			        if(EMAC_Configs.pfnFrameReceive != ((void*) 0))
			        {
        ...
        if(int_stat & 0x00000040 && (EMAC_Configs.pfnTransmitFinish != ((void*) 0)))
        {
		   	 EMAC_Configs.pfnTransmitFinish();
        }

		if(int_stat & 0x00001000 && (EMAC_Configs.pfnSoftInt!= ((void*) 0)))
        {
		   	 EMAC_Configs.pfnSoftInt();
        }

		if(int_stat & 0x00002000 && (EMAC_Configs.pfnWakeup!= ((void*) 0)))
        {
...
void EMAC_SetHashFilter(uint8_t dstMAC_addr[], FunctionalState NewState)
{
	...
	pReg = (crc > 31) ? ((uint32_t *)&((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->HashFilterH) 						: ((uint32_t *)&((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->HashFilterL);
...
void EMAC_SetFilterMode(uint32_t ulFilterMode, FunctionalState NewState)
{
	if (NewState == ENABLE)
	{
		((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->RxFilterCtrl |= ulFilterMode;

		if((ulFilterMode & 0x00000010) &&
			((ulFilterMode & 0x00000004) == 0))
		{
		  ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->RxFilterCtrl &= ~0x00000004;
		}
		if((ulFilterMode & 0x00000008) &&
			((ulFilterMode & 0x00000001) == 0))
		{
		  ((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->RxFilterCtrl &= ~0x00000001;
		}
	}
	else
	{
...
FlagStatus EMAC_GetWoLStatus(uint32_t ulWoLMode)
{
	if (((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->RxFilterWoLStatus & ulWoLMode)
	{
		((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->RxFilterWoLClear = ulWoLMode;
...
void EMAC_IntCmd(uint32_t ulIntType, FunctionalState NewState)
{
	if (NewState == ENABLE)
	{
		((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->IntEnable |= ulIntType;
	}
	else
	{
		((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->IntEnable &= ~(ulIntType);
...
IntStatus EMAC_IntGetStatus(uint32_t ulIntType)
{
	if (((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->IntStatus & ulIntType)
	{
		((LPC_EMAC_TypeDef *) ((0x20080000UL) + 0x04000) )->IntClear = ulIntType;
		return SET;
	}
	else
	{
