...
#line 49 "..\\Lwip\\core\\ipv4\\icmp.c"
#line 50 "..\\Lwip\\core\\ipv4\\icmp.c"
#line 51 "..\\Lwip\\core\\ipv4\\icmp.c"
...
icmp_input(struct pbuf *p, struct netif *inp)
{
  ...
  hlen = ((u8_t)(((iphdr_in)->_v_hl & 0x0f) * 4));
  if (hlen < 20) {
    ;
    goto lenerr;
  }
  ...
  switch (type) {
    ...
    case 8:
      ...
      if (pbuf_add_header(p, hlen + (14 + 0) + 0)) {
        ...
        if (pbuf_remove_header(r, hlen)) {
          do { if (!(0)) { do {printf("icmp_input: moving r->payload to icmp header failed\n");}while(0); }} while(0);
          pbuf_free(r);
          goto icmperr;
        }
        ...
        if (pbuf_remove_header(p, hlen + (14 + 0) + 0)) {
          do { if (!(0)) { do {printf("icmp_input: restoring original p->payload failed\n");}while(0); }} while(0);
          goto icmperr;
        }
      }
      ...
      if (pbuf_add_header(p, hlen)) {
        ...
        ((iecho)->type = (0));
#line 231 "..\\Lwip\\core\\ipv4\\icmp.c"
        iecho->chksum = 0;
...
icmp_send_response(struct pbuf *p, u8_t type, u8_t code)
{
  ...
  do { if (!((q->len >= (sizeof(struct icmp_echo_hdr) + 20 + 8)))) { do {printf("check that first pbuf can hold icmp message");}while(0); }} while(0);
...
#line 388 "..\\Lwip\\core\\ipv4\\icmp.c"
