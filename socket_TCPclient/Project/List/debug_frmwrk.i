...
#line 27 "..\\..\\Drivers\\source\\debug_frmwrk.c"
...
#line 28 "..\\..\\Drivers\\source\\debug_frmwrk.c"
												...
												uint8_t numCh, uint32_t* val)
{
	...
	factor = (option == (1)) ? 16 : ((option == (0)) ? 10 : 0);
...
#line 514 "..\\..\\Drivers\\source\\debug_frmwrk.c"
	...
	UART_Init((LPC_UART_TypeDef *)((LPC_UART4_TypeDef *) ((0x40080000UL) + 0x24000) ), &UARTConfigStruct);

	
	UART_TxCmd((LPC_UART_TypeDef *)((LPC_UART4_TypeDef *) ((0x40080000UL) + 0x24000) ), ENABLE);
