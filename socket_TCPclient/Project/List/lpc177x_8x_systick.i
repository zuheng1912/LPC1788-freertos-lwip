#line 1 "..\\..\\Drivers\\source\\lpc177x_8x_systick.c"
...
#line 1 "..\\..\\Drivers\\include\\lpc177x_8x_systick.h"
...
#line 38 "..\\..\\Drivers\\include\\lpc177x_8x_systick.h"
...
#line 39 "..\\..\\Drivers\\include\\lpc177x_8x_systick.h"
...
#line 34 "..\\..\\Drivers\\source\\lpc177x_8x_systick.c"
...
#line 35 "..\\..\\Drivers\\source\\lpc177x_8x_systick.c"
...
void SYSTICK_InternalInit(uint32_t time)
{
	...
	else
	{
		...
		((SysTick_Type *) ((0xE000E000UL) + 0x0010UL))->CTRL |= ((uint32_t)(1<<2));

		


 
		((SysTick_Type *) ((0xE000E000UL) + 0x0010UL))->RELOAD = (cclk/1000)*time - 1;
	}
}
...
void SYSTICK_ExternalInit(uint32_t freq, uint32_t time)
{
	...
	else
	{
		...
		((SysTick_Type *) ((0xE000E000UL) + 0x0010UL))->RELOAD = (freq/1000)*time - 1;
	}
}
...
void SYSTICK_Cmd(FunctionalState NewState)
{
	if(NewState == ENABLE)
		...
		((SysTick_Type *) ((0xE000E000UL) + 0x0010UL))->CTRL |= ((uint32_t)(1<<0));
	else
...
void SYSTICK_IntCmd(FunctionalState NewState)
{
	if(NewState == ENABLE)
		...
		((SysTick_Type *) ((0xE000E000UL) + 0x0010UL))->CTRL |= ((uint32_t)(1<<1));
	else
...
uint32_t SYSTICK_GetCurrentValue(void)
{
	return (((SysTick_Type *) ((0xE000E000UL) + 0x0010UL))->CURR);
}
...
void SYSTICK_ClearCounterFlag(void)
{
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL))->CTRL &= ~((uint32_t)(1<<16));
}
