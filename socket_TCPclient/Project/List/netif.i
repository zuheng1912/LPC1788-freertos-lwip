...
netif_input(struct pbuf *p, struct netif *inp)
{
  ...
  do { if (!(p != 0)) { do {printf("netif_input: invalid pbuf");}while(0); }} while(0);
  do { if (!(inp != 0)) { do {printf("netif_input: invalid netif");}while(0); }} while(0);
...
#line 294 "..\\Lwip\\core\\netif.c"
  ...
  do { if (!(netif != 0)) { do {printf("netif_add: invalid netif");}while(0); return 0;}} while(0);
  do { if (!(init != 0)) { do {printf("netif_add: No init function given");}while(0); return 0;}} while(0);
...
#line 355 "..\\Lwip\\core\\netif.c"
 ...
 
  {
    ...
    do {
      ...
      num_netifs = 0;
      for (netif2 = netif_list; netif2 != 0; netif2 = netif2->next) {
        do { if (!(netif2 != netif)) { do {printf("netif already added");}while(0); }} while(0);
        num_netifs++;
        do { if (!(num_netifs <= 255)) { do {printf("too many netifs, max. supported number is 255");}while(0); }} while(0);
...
{
  do { if (!(ipaddr != 0)) { do {printf("invalid pointer");}while(0); }} while(0);
  do { if (!(old_addr != 0)) { do {printf("invalid pointer");}while(0); }} while(0);

   
  if (((ipaddr)->addr == (((const ip4_addr_t*)(&((netif)->ip_addr))))->addr) == 0) {
    ip_addr_t new_addr;
    *(&new_addr) = *ipaddr;
    ;

    ((*old_addr). addr = (*((const ip_addr_t*)&((netif)->ip_addr))). addr);
...
netif_set_ipaddr(struct netif *netif, const ip4_addr_t *ipaddr)
{
  ...
  do { if (!(netif != 0)) { do {printf("netif_set_ipaddr: invalid netif");}while(0); return;}} while(0);
...
netif_do_set_netmask(struct netif *netif, const ip4_addr_t *netmask, ip_addr_t *old_nm)
{
  ...
  if (((netmask)->addr == (((const ip4_addr_t*)(&((netif)->netmask))))->addr) == 0) {
...
netif_set_netmask(struct netif *netif, const ip4_addr_t *netmask)
{
  ...
  do { if (!(netif != 0)) { do {printf("netif_set_netmask: invalid netif");}while(0); return;}} while(0);
...
netif_do_set_gw(struct netif *netif, const ip4_addr_t *gw, ip_addr_t *old_gw)
{
  ...
  if (((gw)->addr == (((const ip4_addr_t*)(&((netif)->gw))))->addr) == 0) {
...
netif_set_gw(struct netif *netif, const ip4_addr_t *gw)
{
  ...
  do { if (!(netif != 0)) { do {printf("netif_set_gw: invalid netif");}while(0); return;}} while(0);
...
netif_remove(struct netif *netif)
{
  ...
  if (!((*((const ip4_addr_t*)(&((netif)->ip_addr)))). addr == ((u32_t)0x00000000UL))) {
    netif_do_ip_addr_changed(((const ip_addr_t*)&((netif)->ip_addr)), 0);
  }
...
netif_set_up(struct netif *netif)
{
  ...
  do { if (!(netif != 0)) { do {printf("netif_set_up: invalid netif");}while(0); return;}} while(0);

  if (!(netif->flags & 0x01U)) {
    do { (netif)->flags = (u8_t)((netif)->flags | (0x01U)); } while(0);
...
{
  do { if (!(netif != 0)) { do {printf("netif_issue_reports: invalid netif");}while(0); }} while(0);
...
netif_set_down(struct netif *netif)
{
  ...
  do { if (!(netif != 0)) { do {printf("netif_set_down: invalid netif");}while(0); return;}} while(0);

  if (netif->flags & 0x01U) {
#line 933 "..\\Lwip\\core\\netif.c"

    do { (netif)->flags = (u8_t)((netif)->flags & (u8_t)(~(0x01U) & 0xff)); } while(0);
    ;
...
netif_set_link_up(struct netif *netif)
{
  ...
  do { if (!(netif != 0)) { do {printf("netif_set_link_up: invalid netif");}while(0); return;}} while(0);

  if (!(netif->flags & 0x04U)) {
    do { (netif)->flags = (u8_t)((netif)->flags | (0x04U)); } while(0);
...
netif_set_link_down(struct netif *netif)
{
  ...
  do { if (!(netif != 0)) { do {printf("netif_set_link_down: invalid netif");}while(0); return;}} while(0);

  if (netif->flags & 0x04U) {
    do { (netif)->flags = (u8_t)((netif)->flags & (u8_t)(~(0x04U) & 0xff)); } while(0);
    ;
#line 1042 "..\\Lwip\\core\\netif.c"
  }
}
