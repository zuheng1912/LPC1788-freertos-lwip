...
{
  do { if (!((buf != 0))) { do {printf("netbuf_alloc: invalid buf");}while(0); return 0;;}} while(0);
  ...
  do { if (!((buf->p->len >= size))) { do {printf("check that first pbuf can hold size");}while(0); }} while(0);
...
{
  do { if (!((buf != 0))) { do {printf("netbuf_free: invalid buf");}while(0); return;;}} while(0);
  if (buf->p != 0) {
    pbuf_free(buf->p);
  }
  buf->p = buf->ptr = 0;
...
{
  do { if (!((buf != 0))) { do {printf("netbuf_ref: invalid buf");}while(0); return ERR_ARG;;}} while(0);
  if (buf->p != 0) {
    pbuf_free(buf->p);
  }
...
{
  do { if (!((head != 0))) { do {printf("netbuf_chain: invalid head");}while(0); return;;}} while(0);
  do { if (!((tail != 0))) { do {printf("netbuf_chain: invalid tail");}while(0); return;;}} while(0);
...
{
  do { if (!((buf != 0))) { do {printf("netbuf_data: invalid buf");}while(0); return ERR_ARG;;}} while(0);
  do { if (!((dataptr != 0))) { do {printf("netbuf_data: invalid dataptr");}while(0); return ERR_ARG;;}} while(0);
  do { if (!((len != 0))) { do {printf("netbuf_data: invalid len");}while(0); return ERR_ARG;;}} while(0);
...
{
  do { if (!((buf != 0))) { do {printf("netbuf_next: invalid buf");}while(0); return -1;;}} while(0);
  if (buf->ptr->next == 0) {
    return -1;
  }
...
{
  do { if (!((buf != 0))) { do {printf("netbuf_first: invalid buf");}while(0); return;;}} while(0);
  buf->ptr = buf->p;
}
