#line 1 "..\\Lwip\\core\\ipv4\\ip4_addr.c"
...
#line 40 "..\\Lwip\\core\\ipv4\\ip4_addr.c"
...
#line 44 "..\\Lwip\\core\\ipv4\\ip4_addr.c"
...
#line 45 "..\\Lwip\\core\\ipv4\\ip4_addr.c"
...
ip4addr_aton(const char *cp, ip4_addr_t *addr)
{
  ...
  for (;;) {
    ...
    if (!((* __rt_ctype_table())[(unsigned char)(c)] == 32)) {
      return 0;
    }
    val = 0;
    base = 10;
    ...
    for (;;) {
      if (((* __rt_ctype_table())[(unsigned char)(c)] == 32)) {
        ...
        c = *++cp;
      } else if (base == 16 && (__isxdigit_helper((* __rt_ctype_table())[(unsigned char)(c)]) & 128)) {
        val = (val << 4) | (u32_t)(c + 10 - (((* __rt_ctype_table())[(unsigned char)(c)] & 8) ? 'a' : 'A'));
        c = *++cp;
      } else {
        break;
      }
  ...
  if (c != '\0' && !((* __rt_ctype_table())[(unsigned char)(c)] & 1)) {
    return 0;
  }
  ...
  switch (pp - parts + 1) {
    ...
    case 4:              
      ...
      break;
    default:
      do { if (!(0)) { do {printf("unhandled");}while(0); }} while(0);
      break;
  }
  if (addr) {
