...
#line 33 "..\\User\\arch\\sys_arch.c"

#line 35 "..\\User\\arch\\sys_arch.c"
#line 36 "..\\User\\arch\\sys_arch.c"
...
#line 38 "..\\User\\arch\\sys_arch.c"
#line 1 "..\\Lwip\\include\\lwip/init.h"
...
#line 41 "..\\Lwip\\include\\lwip/init.h"
...
#line 82 "..\\Lwip\\include\\lwip/init.h"
...
#line 39 "..\\User\\arch\\sys_arch.c"
#line 40 "..\\User\\arch\\sys_arch.c"
#line 1 "..\\Lwip\\include\\lwip/sio.h"
...
#line 39 "..\\Lwip\\include\\lwip/sio.h"
#line 40 "..\\Lwip\\include\\lwip/sio.h"
...
#line 45 "..\\User\\arch\\sys_arch.c"
#line 47 "..\\User\\arch\\sys_arch.c"
#line 48 "..\\User\\arch\\sys_arch.c"
#line 49 "..\\User\\arch\\sys_arch.c"
...
static struct timeoutlist s_timeoutlist[4];
...
sys_sem_new(sys_sem_t*sem, u8_t count)
{
  ...
  {    
    ...
    *sem = xQueueCreateCountingSemaphore( ( count ), ( count ) );
  
#line 155 "..\\User\\arch\\sys_arch.c"
...
sys_sem_free(sys_sem_t *sem)
{
  ...
  *sem = (SemaphoreHandle_t)0;
}


int sys_sem_valid(sys_sem_t *sem)                                               
{
  return (*sem != (SemaphoreHandle_t)0);                                    
}
...
sys_arch_sem_wait(sys_sem_t *sem, u32_t timeout)
{
  ...
  if(timeout != 0)
  {
    ...
    wait_tick = timeout / ( ( TickType_t ) 1000 / (( TickType_t )1000) );
    if (wait_tick == 0)
      wait_tick = 1;
  }
  else
    wait_tick = ( TickType_t ) 0xffffffffUL;  
  
  
  if(xQueueSemaphoreTake( ( *sem ), ( wait_tick ) ) == ( ( BaseType_t ) 1 ))
    return ((xTaskGetTickCount()-start_tick)*( ( TickType_t ) 1000 / (( TickType_t )1000) ));
  else
    return 0xffffffffUL;
}
...
{
  if(xQueueGenericSend( ( QueueHandle_t ) ( *sem ), 0, ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 ))
...
{
  *mutex = (SemaphoreHandle_t)0;
}

void
sys_mutex_lock(sys_mutex_t *mutex)
{
  xQueueSemaphoreTake( ( *mutex ), ( ( TickType_t ) 0xffffffffUL ) );  
...
sys_mbox_new(sys_mbox_t *mbox, int size)
{
  ...
  *mbox = xQueueGenericCreate( ( (UBaseType_t ) size ), ( (UBaseType_t ) sizeof(void *) ), ( ( ( uint8_t ) 0U ) ) ); 
#line 308 "..\\User\\arch\\sys_arch.c"
	if(0 == *mbox)
    return ERR_MEM;
...
{
  *mbox = (QueueHandle_t)0; 
}

void
sys_mbox_post(sys_mbox_t *q, void *msg)
{
  while(xQueueGenericSend( ( *q ), ( &msg ), ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 ));  
...
{
  if(xQueueGenericSend( ( *q ), ( &msg ), ( 0 ), ( ( BaseType_t ) 0 ) ) == ( ( ( BaseType_t ) 1 ) ))  
    return ERR_OK;
  else
    return ERR_MEM;
}
...
sys_arch_mbox_fetch(sys_mbox_t *q, void **msg, u32_t timeout)
{
  ...
  if(xQueueReceive(*q,&(*msg), wait_tick) == ( ( BaseType_t ) 1 ))
    return ((sys_now() - start_tick)*( ( TickType_t ) 1000 / (( TickType_t )1000) ));
  else
  {
    *msg = 0;
    return 0xffffffffUL;
...
sys_arch_mbox_tryfetch(sys_mbox_t *q, void **msg)
{
  ...
  if(xQueueReceive(*q,&(*msg), 0) == ( ( BaseType_t ) 1 ))
    return ERR_OK;
  else
    return 0xffffffffUL;
}
...
void TCPIP_Init(void)
{
  ...
  netif_add(&gnetif, &ipaddr, &netmask, &gw, 0, &ethernetif_init, &tcpip_input);
  ...
  while(((&(gnetif . ip_addr))->addr == (&ipaddr)->addr))   
  {
    vTaskDelay(1);
  } 
