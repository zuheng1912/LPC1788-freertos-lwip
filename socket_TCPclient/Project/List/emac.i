...
#line 19 "..\\User\\arch\\EMAC.c"
#line 1 "..\\User\\arch\\phylan.h"
...
#line 34 "..\\User\\arch\\phylan.h"
#line 35 "..\\User\\arch\\phylan.h"
...
#line 20 "..\\User\\arch\\EMAC.c"
#line 21 "..\\User\\arch\\EMAC.c"
...
#line 23 "..\\User\\arch\\EMAC.c"



uint16_t *rptr = ((void*) 0);
uint16_t rx_size[(2)];
uint16_t* rx_ptr[(2)];
uint8_t rx_done = 0, read_done = 0;
...
void Init_EMAC(void)
{
	...
	uint8_t EMACAddr[] = {0x00, 0x00, 0x00, 	                      0x00, 0x00, 0x01};
	...
	Emac_Config.PhyCfg.Mode= (0);
	Emac_Config.pbEMAC_Addr = EMACAddr;
	Emac_Config.bPhyAddr = 0x0100;
	...
	Emac_Config.pfnTransmitFinish = ((void*) 0);
	Emac_Config.pfnSoftInt = ((void*) 0);
	Emac_Config.pfnWakeup = ((void*) 0);
