#line 1 "..\\Lwip\\core\\ipv4\\etharp.c"
...
#line 47 "..\\Lwip\\core\\ipv4\\etharp.c"
...
#line 51 "..\\Lwip\\core\\ipv4\\etharp.c"
#line 52 "..\\Lwip\\core\\ipv4\\etharp.c"
...
#line 53 "..\\Lwip\\core\\ipv4\\etharp.c"
...
#line 54 "..\\Lwip\\core\\ipv4\\etharp.c"
...
#line 55 "..\\Lwip\\core\\ipv4\\etharp.c"
...
#line 56 "..\\Lwip\\core\\ipv4\\etharp.c"
#line 1 "..\\Lwip\\include\\netif/ethernet.h"
...
#line 57 "..\\Lwip\\core\\ipv4\\etharp.c"
...
#line 59 "..\\Lwip\\core\\ipv4\\etharp.c"
...
#line 125 "..\\Lwip\\core\\ipv4\\etharp.c"
...
#line 160 "..\\Lwip\\core\\ipv4\\etharp.c"
...
#line 188 "..\\Lwip\\core\\ipv4\\etharp.c"
}
...
{
  s16_t old_pending = 10, old_stable = 10;
  s16_t empty = 10;
  s16_t i = 0;
  ...
  for (i = 0; i < 10; ++i) {
    ...
    if ((empty == 10) && (state == ETHARP_STATE_EMPTY)) {
      ...
      do { if (!(state == ETHARP_STATE_PENDING || state >= ETHARP_STATE_STABLE)) { do {printf("state == ETHARP_STATE_PENDING || state >= ETHARP_STATE_STABLE");}while(0); }} while(0);

       
      if (ipaddr && ((ipaddr)->addr == (&arp_table[i]. ipaddr)->addr)

          && ((netif == 0) || (netif == arp_table[i].netif))
  ...
  if (empty < 10) {
    ...
    if (old_stable < 10) {
      ...
      do { if (!(arp_table[i]. q == 0)) { do {printf("arp_table[i].q == NULL");}while(0); }} while(0);
    ...
    do { if (!(i < 10)) { do {printf("i < ARP_TABLE_SIZE");}while(0); }} while(0);
    etharp_free_entry(i);
  }

  do { if (!(i < 10)) { do {printf("i < ARP_TABLE_SIZE");}while(0); }} while(0);
  do { if (!(arp_table[i]. state == ETHARP_STATE_EMPTY)) { do {printf("arp_table[i].state == ETHARP_STATE_EMPTY");}while(0); }} while(0);
...
{
  s16_t i;
  do { if (!(netif->hwaddr_len == 6)) { do {printf("netif->hwaddr_len == ETH_HWADDR_LEN");}while(0); }} while(0);
  ;
  ...
  if (((ipaddr) == 0 || ((*(ipaddr)). addr == ((u32_t)0x00000000UL))) ||
      ...
      (((ipaddr)->addr & ((((0xf0000000UL) & (u32_t)0x000000ffUL) << 24) | (((0xf0000000UL) & (u32_t)0x0000ff00UL) << 8) | (((0xf0000000UL) & (u32_t)0x00ff0000UL) >> 8) | (((0xf0000000UL) & (u32_t)0xff000000UL) >> 24))) == ((((0xe0000000UL) & (u32_t)0x000000ffUL) << 24) | (((0xe0000000UL) & (u32_t)0x0000ff00UL) << 8) | (((0xe0000000UL) & (u32_t)0x00ff0000UL) >> 8) | (((0xe0000000UL) & (u32_t)0xff000000UL) >> 24)))) {
    ;
    return ERR_ARG;
  }
...
#line 453 "..\\Lwip\\core\\ipv4\\etharp.c"
  {
...
#line 481 "..\\Lwip\\core\\ipv4\\etharp.c"
  if (arp_table[i].q != 0) {
...
#line 552 "..\\Lwip\\core\\ipv4\\etharp.c"
                 ...
                 struct eth_addr **eth_ret, const ip4_addr_t **ip_ret)
{
  ...
  do { if (!(eth_ret != 0 && ip_ret != 0)) { do {printf("eth_ret != NULL && ip_ret != NULL");}while(0); }} while(0);
...
{
  do { if (!(ipaddr != 0)) { do {printf("ipaddr != NULL");}while(0); }} while(0);
  do { if (!(netif != 0)) { do {printf("netif != NULL");}while(0); }} while(0);
  do { if (!(eth_ret != 0)) { do {printf("eth_ret != NULL");}while(0); }} while(0);
...
etharp_input(struct pbuf *p, struct netif *netif)
{
  ...
  if ((hdr->hwtype != ((u16_t)((((LWIP_IANA_HWTYPE_ETHERNET) & (u16_t)0x00ffU) << 8) | (((LWIP_IANA_HWTYPE_ETHERNET) & (u16_t)0xff00U) >> 8)))) ||
      (hdr->hwlen != 6) ||
      (hdr->protolen != sizeof(ip4_addr_t)) ||
      (hdr->proto != ((u16_t)((((ETHTYPE_IP) & (u16_t)0x00ffU) << 8) | (((ETHTYPE_IP) & (u16_t)0xff00U) >> 8)))))  {
    ;
...
#line 675 "..\\Lwip\\core\\ipv4\\etharp.c"
  ...
  switch (hdr->opcode) {
    ...
    case ((u16_t)((((ARP_REQUEST) & (u16_t)0x00ffU) << 8) | (((ARP_REQUEST) & (u16_t)0xff00U) >> 8))):
      ...
      break;
    case ((u16_t)((((ARP_REPLY) & (u16_t)0x00ffU) << 8) | (((ARP_REPLY) & (u16_t)0xff00U) >> 8))):
...
{
  do { if (!(arp_table[arp_idx]. state >= ETHARP_STATE_STABLE)) { do {printf("arp_table[arp_idx].state >= ETHARP_STATE_STABLE");}while(0); }} while(0);
...
etharp_output(struct netif *netif, struct pbuf *q, const ip4_addr_t *ipaddr)
{
  ...
  ;
  do { if (!(netif != 0)) { do {printf("netif != NULL");}while(0); }} while(0);
  do { if (!(q != 0)) { do {printf("q != NULL");}while(0); }} while(0);
  do { if (!(ipaddr != 0)) { do {printf("ipaddr != NULL");}while(0); }} while(0);
  ...
  if (ip4_addr_isbroadcast_u32((ipaddr)->addr, netif)) {
  ...
  } else if ((((ipaddr)->addr & ((((0xf0000000UL) & (u32_t)0x000000ffUL) << 24) | (((0xf0000000UL) & (u32_t)0x0000ff00UL) << 8) | (((0xf0000000UL) & (u32_t)0x00ff0000UL) >> 8) | (((0xf0000000UL) & (u32_t)0xff000000UL) >> 24))) == ((((0xe0000000UL) & (u32_t)0x000000ffUL) << 24) | (((0xe0000000UL) & (u32_t)0x0000ff00UL) << 8) | (((0xe0000000UL) & (u32_t)0x00ff0000UL) >> 8) | (((0xe0000000UL) & (u32_t)0xff000000UL) >> 24)))) {
    ...
    if (!(((ipaddr)->addr & (((const ip4_addr_t*)(&((netif)->netmask))))->addr) == ((((const ip4_addr_t*)(&((netif)->ip_addr))))->addr & (((const ip4_addr_t*)(&((netif)->netmask))))->addr)) &&
        !(((ipaddr)->addr & ((((0xffff0000UL) & (u32_t)0x000000ffUL) << 24) | (((0xffff0000UL) & (u32_t)0x0000ff00UL) << 8) | (((0xffff0000UL) & (u32_t)0x00ff0000UL) >> 8) | (((0xffff0000UL) & (u32_t)0xff000000UL) >> 24))) == ((((0xa9fe0000UL) & (u32_t)0x000000ffUL) << 24) | (((0xa9fe0000UL) & (u32_t)0x0000ff00UL) << 8) | (((0xa9fe0000UL) & (u32_t)0x00ff0000UL) >> 8) | (((0xa9fe0000UL) & (u32_t)0xff000000UL) >> 24)))) {
#line 835 "..\\Lwip\\core\\ipv4\\etharp.c"
      {
#line 842 "..\\Lwip\\core\\ipv4\\etharp.c"
        {
...
#line 861 "..\\Lwip\\core\\ipv4\\etharp.c"
...
etharp_query(struct netif *netif, const ip4_addr_t *ipaddr, struct pbuf *q)
{
  ...
  do { if (!((size_t)i_err < 0x7F)) { do {printf("type overflow");}while(0); }} while(0);
  ...
  do { if (!(((arp_table[i]. state == ETHARP_STATE_PENDING) || (arp_table[i]. state >= ETHARP_STATE_STABLE)))) { do {printf("arp_table[i].state == PENDING or STABLE");}while(0); }} while(0);
  ...
  if (arp_table[i].state >= ETHARP_STATE_STABLE) {
    ...
    p = q;
    while (p) {
      do { if (!((p->len != p->tot_len) || (p->next == 0))) { do {printf("no packet queues allowed!");}while(0); }} while(0);
      if (((p)->type_internal & 0x40)) {
        copy_needed = 1;
        break;
      }
      p = p->next;
...
#line 1067 "..\\Lwip\\core\\ipv4\\etharp.c"
           ...
           const u16_t opcode)
{
  ...
  do { if (!((p->len >= 28))) { do {printf("check that first pbuf can hold struct etharp_hdr");}while(0); }} while(0);
  ...
  do { if (!((netif->hwaddr_len == 6))) { do {printf("netif->hwaddr_len must be the same as ETH_HWADDR_LEN for etharp!");}while(0); }} while(0);
  ...
  hdr->hwtype = ((u16_t)((((LWIP_IANA_HWTYPE_ETHERNET) & (u16_t)0x00ffU) << 8) | (((LWIP_IANA_HWTYPE_ETHERNET) & (u16_t)0xff00U) >> 8)));
  hdr->proto = ((u16_t)((((ETHTYPE_IP) & (u16_t)0x00ffU) << 8) | (((ETHTYPE_IP) & (u16_t)0xff00U) >> 8)));
...
#line 1155 "..\\Lwip\\core\\ipv4\\etharp.c"
  {
