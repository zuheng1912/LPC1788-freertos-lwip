...
#line 33 "FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c"
...
static void prvTaskExitError( void )
{
    ...
    if((uxCriticalNesting == ~0UL)==0) printf("Error:%s,%d\r\n","FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c",204);
    vPortRaiseBASEPRI();
...
BaseType_t xPortStartScheduler( void )
{

        {
            ...
            *pucFirstUserPriorityRegister = ( ( uint8_t ) 0xff );
            ...
            if((ucMaxPriorityValue == ( ( 31 << (8 - 5) ) & ucMaxPriorityValue ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c",285);

             
            ucMaxSysCallPriority = ( 5 << (8 - 5) ) & ucMaxPriorityValue;
            ...
            while( ( ucMaxPriorityValue & ( ( uint8_t ) 0x80 ) ) == ( ( uint8_t ) 0x80 ) )
            {
...

                {
                    ...
                    if((( ( ( uint8_t ) 7 ) - ulMaxPRIGROUPValue ) == 5)==0) printf("Error:%s,%d\r\n","FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c",305);
                }
...

                {
                    ...
                    if((( ( ( uint8_t ) 7 ) - ulMaxPRIGROUPValue ) == 5)==0) printf("Error:%s,%d\r\n","FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c",314);
                }
    ...
    ( *( ( volatile uint32_t * ) 0xe000ed20 ) ) |= ( ( ( uint32_t ) ( 31 << (8 - 5) ) ) << 16UL );

    ( *( ( volatile uint32_t * ) 0xe000ed20 ) ) |= ( ( ( uint32_t ) ( 31 << (8 - 5) ) ) << 24UL );
...
void vPortEndScheduler( void )
{
    ...
    if((uxCriticalNesting == 1000UL)==0) printf("Error:%s,%d\r\n","FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c",353);
}
...
void vPortEnterCritical( void )
{
    ...
    {
        if((( ( *( ( volatile uint32_t * ) 0xe000ed04 ) ) & ( 0xFFUL ) ) == 0)==0) printf("Error:%s,%d\r\n","FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c",369);
    }
}
...
{
    if((uxCriticalNesting)==0) printf("Error:%s,%d\r\n","FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c",376);
    uxCriticalNesting--;
...
#line 615 "FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c"
...
#line 634 "FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c"
...
__asm uint32_t vPortGetIPSR( void )
{
    ...
    void vPortValidateInterruptPriority( void )
    {
        ...
        if( ulCurrentInterrupt >= ( 16 ) )
        {
            ...
            if((ucCurrentPriority >= ucMaxSysCallPriority)==0) printf("Error:%s,%d\r\n","FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c",697);
        }
        ...
        if((( ( *( ( volatile uint32_t * ) 0xE000ED0C ) ) & ( 0x07UL << 8UL ) ) <= ulMaxPRIGROUPValue)==0) printf("Error:%s,%d\r\n","FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c",713);
    }
