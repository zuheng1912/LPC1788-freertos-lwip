...
#line 860 ".\\FreeRTOS\\include\\stream_buffer.h"
...
static void prvInitialiseNewStreamBuffer( StreamBuffer_t * const pxStreamBuffer,
                                                     ...
                                                     BaseType_t xIsMessageBuffer )
    {
        ...
        if( xIsMessageBuffer == ( ( BaseType_t ) 1 ) )
        {
            ...
            ucFlags = ( ( uint8_t ) 1 );
            if((xBufferSizeBytes > ( sizeof( size_t ) ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",235);
        }
        else
        {
             
            ucFlags = 0;
            if((xBufferSizeBytes > 0)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",241);
        }

        if((xTriggerLevelBytes <= xBufferSizeBytes)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",244);
...
#line 369 "FreeRTOS\\stream_buffer.c"
...
void vStreamBufferDelete( StreamBufferHandle_t xStreamBuffer )
{
    ...
    if((pxStreamBuffer)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",375);
...
#line 394 "FreeRTOS\\stream_buffer.c"
    }
    else
    {
...
BaseType_t xStreamBufferReset( StreamBufferHandle_t xStreamBuffer )
{
    ...
    if((pxStreamBuffer)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",413);

#line 422 "FreeRTOS\\stream_buffer.c"
                          ...
                          TickType_t xTicksToWait )
{
    ...
    if((pvTxData)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",533);
    if((pxStreamBuffer)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",534);
    ...
    if( ( pxStreamBuffer->ucFlags & ( ( uint8_t ) 1 ) ) != ( uint8_t ) 0 )
    {
        ...
        if((xRequiredSpace > xDataLengthBytes)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",545);
        ...
        do
        {
            ...
            vPortEnterCritical();
            {
                ...
                if( xSpace < xRequiredSpace )
                {
                    ...
                    if((pxStreamBuffer->xTaskWaitingToSend == 0)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",593);
                                 ...
                                 BaseType_t * const pxHigherPriorityTaskWoken )
{
    ...
    if((pvTxData)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",658);
    if((pxStreamBuffer)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",659);
                             ...
                             TickType_t xTicksToWait )
{
    ...
    if((pvRxData)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",760);
    if((pxStreamBuffer)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",761);
    ...
    if( xTicksToWait != ( TickType_t ) 0 )
    {
        ...
        vPortEnterCritical();
        {
            ...
            if( xBytesAvailable <= xBytesToStoreMessageLength )
            {
                ...
                if((pxStreamBuffer->xTaskWaitingToReceive == 0)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",796);
...
size_t xStreamBufferNextMessageLengthBytes( StreamBufferHandle_t xStreamBuffer )
{
    ...
    if( ( pxStreamBuffer->ucFlags & ( ( uint8_t ) 1 ) ) != ( uint8_t ) 0 )
    {
        ...
        else
        {
            ...
            if((xBytesAvailable == 0)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",888);
            xReturn = 0;
        }
    }
    else
                                    ...
                                    BaseType_t * const pxHigherPriorityTaskWoken )
{
    ...
    if((pvRxData)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",909);
    if((pxStreamBuffer)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",910);
                                     ...
                                     size_t xCount )
{
    ...
    if((xCount > ( size_t ) 0)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",1137);
    ...
    if((( xNextHead + xFirstLength ) <= pxStreamBuffer->xLength)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",1147);
    ...
    if( xCount > xFirstLength )
    {
        ...
        if((( xCount - xFirstLength ) <= pxStreamBuffer->xLength)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",1155);
                                      ...
                                      size_t xBytesAvailable )
{
    ...
    if( xCount > ( size_t ) 0 )
    {
        ...
        if((xFirstLength <= xMaxCount)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",1201);
        if((( xNextTail + xFirstLength ) <= pxStreamBuffer->xLength)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",1202);
        ...
        if( xCount > xFirstLength )
        {
            ...
            if((xCount <= xMaxCount)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",1210);
                                          ...
                                          uint8_t ucFlags )
{
...

        {
            ...
            if((memset( pucBuffer, ( int ) xWriteValue, xBufferSizeBytes ) == pucBuffer)==0) printf("Error:%s,%d\r\n","FreeRTOS\\stream_buffer.c",1274);
        }  
...
#line 1293 "FreeRTOS\\stream_buffer.c"
 

#line 1304 "FreeRTOS\\stream_buffer.c"
 

#line 1314 "FreeRTOS\\stream_buffer.c"
