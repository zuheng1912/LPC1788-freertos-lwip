...
#line 36 "FreeRTOS\\portable\\MemMang\\heap_4.c"
...
#line 43 "FreeRTOS\\portable\\MemMang\\heap_4.c"
...
#line 44 "FreeRTOS\\portable\\MemMang\\heap_4.c"
...
#line 64 "FreeRTOS\\portable\\MemMang\\heap_4.c"
     static uint8_t ucHeap[ ((size_t)(25*1024)) ];
                ...
                ( ( xWantedSize + xHeapStructSize ) >  xWantedSize ) )  
            {
                ...
                if( ( xWantedSize & ( 0x0007 ) ) != 0x00 )
                {
                            ...
                            > xWantedSize )
                    {
                        ...
                        if((( xWantedSize & ( 0x0007 ) ) == 0)==0) printf("Error:%s,%d\r\n","FreeRTOS\\portable\\MemMang\\heap_4.c",154);
                    }
                    else
                    {
                        xWantedSize = 0;
            ...
            if( ( xWantedSize > 0 ) && ( xWantedSize <= xFreeBytesRemaining ) )
            {
                ...
                if( pxBlock != pxEnd )
                {
                    ...
                    if( ( pxBlock->xBlockSize - xWantedSize ) > ( ( size_t ) ( xHeapStructSize << 1 ) ) )
                    {
                        ...
                        if((( ( ( size_t ) pxNewBlockLink ) & ( 0x0007 ) ) == 0)==0) printf("Error:%s,%d\r\n","FreeRTOS\\portable\\MemMang\\heap_4.c",205);
...
#line 269 "FreeRTOS\\portable\\MemMang\\heap_4.c"

    if((( ( ( size_t ) pvReturn ) & ( size_t ) ( 0x0007 ) ) == 0)==0) printf("Error:%s,%d\r\n","FreeRTOS\\portable\\MemMang\\heap_4.c",270);
    return pvReturn;
}
...
void vPortFree( void * pv )
{
    ...
    if( pv != 0 )
    {
        ...
        if((( pxLink->xBlockSize & xBlockAllocatedBit ) != 0)==0) printf("Error:%s,%d\r\n","FreeRTOS\\portable\\MemMang\\heap_4.c",290);
        if((pxLink->pxNextFreeBlock == 0)==0) printf("Error:%s,%d\r\n","FreeRTOS\\portable\\MemMang\\heap_4.c",291);
...
static void prvHeapInit( void )  
{
    ...
    size_t uxAddress;
    size_t xTotalHeapSize = ((size_t)(25*1024));
