...
int UART2_GetChar (void) 
{
  	...
  	return (((LPC_UART_TypeDef *) ((0x40080000UL) + 0x18000) )->RBR);
}
...
{
	while (!(((LPC_UART_TypeDef *) ((0x40080000UL) + 0x18000) )->LSR & 0x20));            
    return (((LPC_UART_TypeDef *) ((0x40080000UL) + 0x18000) )->THR =ucData);
}
...
int UART3_GetChar (void) 
{
  	...
  	return (((LPC_UART_TypeDef *) ((0x40080000UL) + 0x1C000) )->RBR);
}
...
{
	while (!(((LPC_UART_TypeDef *) ((0x40080000UL) + 0x1C000) )->LSR & 0x20));            
    return (((LPC_UART_TypeDef *) ((0x40080000UL) + 0x1C000) )->THR =ucData);
}
...
void UART2_IRQHandler(){
    ...
    flag  = ((LPC_UART_TypeDef *) ((0x40080000UL) + 0x18000) )->IIR;                          
    flag &= 0x0F;		  
    if((flag == 0X04)&&(((LPC_UART_TypeDef *) ((0x40080000UL) + 0x18000) )->LSR & 0X01))    
		{  
     res=UART2_GetChar();                       
	   UART2_SendByte(res);
...
{     
       UART_SendByte(UART_2, ch);    

      while (UART_CheckBusy(UART_2)); 
       return (ch);  
}  
