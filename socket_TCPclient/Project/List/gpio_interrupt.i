...
{	
	...
	if(GPIO_GetIntStatus(2, 19, 1))
	{
		...
		if(FIO_ByteReadValue(((2)),((uint32_t)(26) / 8))&((1 << ((uint32_t)(26) % 8))))
			FIO_ByteClearValue(((2)), ((uint32_t)(26) / 8), (1 << ((uint32_t)(26) % 8)));
		else
			FIO_ByteSetValue(((2)), ((uint32_t)(26) / 8), (1 << ((uint32_t)(26) % 8)));
	}
	else if(GPIO_GetIntStatus(2, 10, 1))
	{
		GPIO_ClearInt((2), (1 << (10)));
		if(FIO_ByteReadValue(((2)),((uint32_t)(23) / 8))&((1 << ((uint32_t)(23) % 8))))
			FIO_ByteClearValue(((2)), ((uint32_t)(23) / 8), (1 << ((uint32_t)(23) % 8)));
		else
			FIO_ByteSetValue(((2)), ((uint32_t)(23) / 8), (1 << ((uint32_t)(23) % 8)));
	}
}
...
int c_entry (void)
{								
	FIO_ByteSetDir(((2)), ((uint32_t)(27) / 8), (1 << ((uint32_t)(27) % 8)), (1));
	FIO_ByteSetDir(((2)), ((uint32_t)(26) / 8), (1 << ((uint32_t)(26) % 8)), (1));	
	FIO_ByteSetDir(((2)), ((uint32_t)(23) / 8), (1 << ((uint32_t)(23) % 8)), (1));
	FIO_ByteSetDir(((2)), ((uint32_t)(22) / 8), (1 << ((uint32_t)(22) % 8)), (1));

	
	FIO_ByteSetValue(((2)), ((uint32_t)(27) / 8), (1 << ((uint32_t)(27) % 8)));
	FIO_ByteSetValue(((2)), ((uint32_t)(26) / 8), (1 << ((uint32_t)(26) % 8)));
	FIO_ByteSetValue(((2)), ((uint32_t)(23) / 8), (1 << ((uint32_t)(23) % 8)));
	FIO_ByteSetValue(((2)), ((uint32_t)(22) / 8), (1 << ((uint32_t)(22) % 8)));
	...
	while (1)
	{
		FIO_ByteClearValue(((2)), ((uint32_t)(27) / 8), (1 << ((uint32_t)(27) % 8)));
		FIO_ByteSetValue(((2)), ((uint32_t)(22) / 8), (1 << ((uint32_t)(22) % 8)));
		...
		FIO_ByteSetValue(((2)), ((uint32_t)(27) / 8), (1 << ((uint32_t)(27) % 8)));
		FIO_ByteClearValue(((2)), ((uint32_t)(22) / 8), (1 << ((uint32_t)(22) % 8)));
		delay();
	}
}
