...
int32_t PHY_Reset(void)
{
	...
	EMAC_Write_PHY(0x00, (1 << (15)));

	 
	for (tout = 0x100000UL; tout >= 0; tout--)
	{
		regv = EMAC_Read_PHY (0x00);
...
int32_t PHY_SetMode(uint32_t ulPHYMode)
{
	...
	id1 = EMAC_Read_PHY (0x02);
	id2 = EMAC_Read_PHY (0x03);

	if ((id1 == ((0x0007))) && ((id2 >> 4) == (((((0x0030) & 0x3F) << 6) | ((0x000F) & 0x3F)))))
	{
...
int32_t PHY_UpdateStatus(void)
{
	...
	if((regv & (1 << (14))) || (regv & (1 << (12))))
	{
		 
		EMAC_SetFullDuplexMode(ENABLE);
	}
	else if ((regv & (1 << (13))) || (regv & (1 << (11))))
	{
