...
#line 63 "..\\Lwip\\api\\api_lib.c"
#line 64 "..\\Lwip\\api\\api_lib.c"
...
#line 70 "..\\Lwip\\api\\api_lib.c"
#line 71 "..\\Lwip\\api\\api_lib.c"
...
#line 93 "..\\Lwip\\api\\api_lib.c"

#line 105 "..\\Lwip\\api\\api_lib.c"
...
netconn_new_with_proto_and_callback(enum netconn_type t, u8_t proto, netconn_callback callback)
{
  ...
  if (conn != 0) {
    ...
    if (err != ERR_OK) {
      do { if (!(conn->pcb . tcp == 0)) { do {printf("freeing conn without freeing pcb");}while(0); }} while(0);
      do { if (!(sys_mbox_valid(&conn->recvmbox))) { do {printf("conn has no recvmbox");}while(0); }} while(0);

      do { if (!(!sys_mbox_valid(&conn->acceptmbox))) { do {printf("conn->acceptmbox shouldn't exist");}while(0); }} while(0);


      do { if (!(sys_sem_valid(&conn->op_completed))) { do {printf("conn has no op_completed");}while(0); }} while(0);
...
netconn_getaddr(struct netconn *conn, ip_addr_t *addr, u16_t *port, u8_t local)
{
  ...
  do { if (!((conn != 0))) { do {printf("netconn_getaddr: invalid conn");}while(0); return ERR_ARG;;}} while(0);
  do { if (!((addr != 0))) { do {printf("netconn_getaddr: invalid addr");}while(0); return ERR_ARG;;}} while(0);
  do { if (!((port != 0))) { do {printf("netconn_getaddr: invalid port");}while(0); return ERR_ARG;;}} while(0);
...
netconn_bind(struct netconn *conn, const ip_addr_t *addr, u16_t port)
{
  ...
  do { if (!((conn != 0))) { do {printf("netconn_bind: invalid conn");}while(0); return ERR_ARG;;}} while(0);
...
netconn_bind_if(struct netconn *conn, u8_t if_idx)
{
  ...
  do { if (!((conn != 0))) { do {printf("netconn_bind_if: invalid conn");}while(0); return ERR_ARG;;}} while(0);
...
netconn_connect(struct netconn *conn, const ip_addr_t *addr, u16_t port)
{
  ...
  do { if (!((conn != 0))) { do {printf("netconn_connect: invalid conn");}while(0); return ERR_ARG;;}} while(0);
...
netconn_disconnect(struct netconn *conn)
{
  ...
  do { if (!((conn != 0))) { do {printf("netconn_disconnect: invalid conn");}while(0); return ERR_ARG;;}} while(0);
...
netconn_listen_with_backlog(struct netconn *conn, u8_t backlog)
{
  ...
  do { if (!((conn != 0))) { do {printf("netconn_listen: invalid conn");}while(0); return ERR_ARG;;}} while(0);
...
netconn_accept(struct netconn *conn, struct netconn **new_conn)
{
  ...
  do { if (!((new_conn != 0))) { do {printf("netconn_accept: invalid pointer");}while(0); return ERR_ARG;;}} while(0);
  *new_conn = 0;
  do { if (!((conn != 0))) { do {printf("netconn_accept: invalid conn");}while(0); return ERR_ARG;;}} while(0);
  ...
  if (!(sys_mbox_valid(&(conn)->acceptmbox) && (((conn)->flags & 0x01) == 0))) {
  ...
  ;
  if ((((conn)->flags & 0x02) != 0)) {
    if (sys_arch_mbox_tryfetch(&conn->acceptmbox, &accept_ptr) == 0xffffffffUL) {
      ;
      ;
      return ERR_WOULDBLOCK;
    }
  } else {
#line 516 "..\\Lwip\\api\\api_lib.c"
    sys_arch_mbox_fetch(&conn->acceptmbox, &accept_ptr, 0);

  }
  ;
#line 529 "..\\Lwip\\api\\api_lib.c"
...
netconn_recv_data(struct netconn *conn, void **new_buf, u8_t apiflags)
{
  ...
  do { if (!((new_buf != 0))) { do {printf("netconn_recv: invalid pointer");}while(0); return ERR_ARG;;}} while(0);
  *new_buf = 0;
  do { if (!((conn != 0))) { do {printf("netconn_recv: invalid conn");}while(0); return ERR_ARG;;}} while(0);
  ...
  ;
  if ((((conn)->flags & 0x02) != 0) || (apiflags & 0x04) ||
      (conn->flags & 0x01) || (conn->pending_err != ERR_OK)) {
    if (sys_arch_mbox_tryfetch(&conn->recvmbox, &buf) == 0xffffffffUL) {
      err_t err;
      ;
      err = netconn_err(conn);
      if (err != ERR_OK) {
...
#line 620 "..\\Lwip\\api\\api_lib.c"
    sys_arch_mbox_fetch(&conn->recvmbox, &buf, 0);

  }
  ;
#line 633 "..\\Lwip\\api\\api_lib.c"
...
{
  do { if (!((conn != 0) && (((conn->type))&0xF0) == NETCONN_TCP)) { do {printf("netconn_recv_tcp_pbuf: invalid conn");}while(0); return ERR_ARG;;}} while(0);
...
netconn_recv_data_tcp(struct netconn *conn, struct pbuf **new_buf, u8_t apiflags)
{
  ...
  if ((((conn)->flags & (0x80)) != 0)) {
    do { (conn)->flags = (u8_t)((conn)->flags & (u8_t)(~(0x80) & 0xff)); } while(0);
    goto handle_fin;
  }
  ...
  if (buf == 0) {
    if (apiflags & 0x10) {
      ...
      do { (conn)->flags = (u8_t)((conn)->flags | (0x80)); } while(0);
      return ERR_WOULDBLOCK;
    } else {
handle_fin:
      if (conn->callback) { (*conn->callback)(conn, NETCONN_EVT_RCVMINUS, 0); };
...
{
  do { if (!((conn != 0) && (((conn->type))&0xF0) != NETCONN_TCP)) { do {printf("netconn_recv_udp_raw_netbuf: invalid conn");}while(0); return ERR_ARG;;}} while(0);
...
netconn_send(struct netconn *conn, struct netbuf *buf)
{
  ...
  do { if (!((conn != 0))) { do {printf("netconn_send: invalid conn");}while(0); return ERR_ARG;;}} while(0);
                             ...
                             u8_t apiflags, size_t *bytes_written)
{
  ...
  do { if (!((conn != 0))) { do {printf("netconn_write: invalid conn");}while(0); return ERR_ARG;;}} while(0);
  do { if (!((((conn->type)&0xF0) == NETCONN_TCP))) { do {printf("netconn_write: invalid conn->type");}while(0); return ERR_VAL;;}} while(0);
...
#line 1060 "..\\Lwip\\api\\api_lib.c"
  ...
  if (err == ERR_OK) {
    ...
    if (!dontblock) {
      do { if (!(msg . msg . w . offset == size)) { do {printf("do_write failed to write all bytes");}while(0); }} while(0);
    }
  }
  ;
...
netconn_close_shutdown(struct netconn *conn, u8_t how)
{
  ...
  do { if (!((conn != 0))) { do {printf("netconn_close: invalid conn");}while(0); return ERR_ARG;;}} while(0);
...
{
  return netconn_close_shutdown(conn, (u8_t)((shut_rx ? 1 : 0) | (shut_tx ? 2 : 0)));
}

#line 1255 "..\\Lwip\\api\\api_lib.c"

#line 1343 "..\\Lwip\\api\\api_lib.c"

#line 1366 "..\\Lwip\\api\\api_lib.c"
