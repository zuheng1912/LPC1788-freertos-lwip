...
bridgeif_age_tmr(void *arg)
{
  ...
  do { if (!(arg != 0)) { do {printf("invalid arg");}while(0); }} while(0);
...
bridgeif_fdb_init(u16_t max_fdb_entries)
{
  ...
  do { if (!(alloc_len == alloc_len_sizet)) { do {printf("alloc_len == alloc_len_sizet");}while(0); }} while(0);
  ;
