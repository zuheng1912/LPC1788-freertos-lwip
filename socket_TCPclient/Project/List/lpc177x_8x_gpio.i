#line 1 "..\\..\\Drivers\\source\\lpc177x_8x_gpio.c"
...
#line 1 "..\\..\\Drivers\\include\\lpc177x_8x_gpio.h"
...
#line 38 "..\\..\\Drivers\\include\\lpc177x_8x_gpio.h"
...
#line 39 "..\\..\\Drivers\\include\\lpc177x_8x_gpio.h"
...
typedef struct {
	volatile uint8_t FIODIR[4];		 
	   uint32_t RESERVED0[3];	 
	volatile uint8_t FIOMASK[4];	 
	volatile uint8_t FIOPIN[4];		 
	volatile uint8_t FIOSET[4];		 
	volatile  uint8_t FIOCLR[4];		 
} GPIO_Byte_TypeDef;
...
typedef struct {
	...
	volatile uint16_t FIODIRU;		 
	   uint32_t RESERVED0[3];	 
	volatile uint16_t FIOMASKL;		 
	volatile uint16_t FIOMASKU;		 
	volatile uint16_t FIOPINL;		 
	volatile uint16_t FIOPINU;		 
	volatile uint16_t FIOSETL;		 
	volatile uint16_t FIOSETU;		 
	volatile  uint16_t FIOCLRL;		 
	volatile  uint16_t FIOCLRU;		 
...
#line 34 "..\\..\\Drivers\\source\\lpc177x_8x_gpio.c"
...
static LPC_GPIO_TypeDef *GPIO_GetPointer(uint8_t portNum)
{
	LPC_GPIO_TypeDef *pGPIO = ((void*) 0);

	switch (portNum)
	{
		case 0:
			pGPIO = ((LPC_GPIO_TypeDef *) ((0x20080000UL) + 0x18000) );
			break;

		case 1:
			pGPIO = ((LPC_GPIO_TypeDef *) ((0x20080000UL) + 0x18020) );
			break;

		case 2:
			pGPIO = ((LPC_GPIO_TypeDef *) ((0x20080000UL) + 0x18040) );
			break;

		case 3:
			pGPIO = ((LPC_GPIO_TypeDef *) ((0x20080000UL) + 0x18060) );
			break;

		case 4:
			pGPIO = ((LPC_GPIO_TypeDef *) ((0x20080000UL) + 0x18080) );
			break;
...
static GPIO_HalfWord_TypeDef *FIO_HalfWordGetPointer(uint8_t portNum)
{
	GPIO_HalfWord_TypeDef *pFIO = ((void*) 0);

	switch (portNum)
	{
		case 0:
			pFIO = ((GPIO_HalfWord_TypeDef *)(((0x20080000UL) + 0x18000)));
			break;

		case 1:
			pFIO = ((GPIO_HalfWord_TypeDef *)(((0x20080000UL) + 0x18020)));
			break;

		case 2:
			pFIO = ((GPIO_HalfWord_TypeDef *)(((0x20080000UL) + 0x18040)));
			break;

		case 3:
			pFIO = ((GPIO_HalfWord_TypeDef *)(((0x20080000UL) + 0x18060)));
			break;

		case 4:
			pFIO = ((GPIO_HalfWord_TypeDef *)(((0x20080000UL) + 0x18080)));
			break;

		case 5:
			pFIO = ((GPIO_HalfWord_TypeDef *)(((0x20080000UL) + 0x180A0)));
			break;
...
static GPIO_Byte_TypeDef *FIO_ByteGetPointer(uint8_t portNum)
{
	GPIO_Byte_TypeDef *pFIO = ((void*) 0);

	switch (portNum)
	{
		case 0:
			pFIO = ((GPIO_Byte_TypeDef *)(((0x20080000UL) + 0x18000)));
			break;

		case 1:
			pFIO = ((GPIO_Byte_TypeDef *)(((0x20080000UL) + 0x18020)));
			break;

		case 2:
			pFIO = ((GPIO_Byte_TypeDef *)(((0x20080000UL) + 0x18040)));
			break;

		case 3:
			pFIO = ((GPIO_Byte_TypeDef *)(((0x20080000UL) + 0x18060)));
			break;

		case 4:
			pFIO = ((GPIO_Byte_TypeDef *)(((0x20080000UL) + 0x18080)));
			break;
...
void GPIO_IntCmd(uint8_t portNum, uint32_t bitValue, uint8_t edgeState)
{
	if((portNum == 0)&&(edgeState == 0))
		((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO0IntEnR = bitValue;
	else if ((portNum == 2)&&(edgeState == 0))
		((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO2IntEnR = bitValue;
	else if ((portNum == 0)&&(edgeState == 1))
		((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO0IntEnF = bitValue;
	else if ((portNum == 2)&&(edgeState == 1))
		((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO2IntEnF = bitValue;
	else
...
{
	if((portNum == 0) && (edgeState == 0))
		return(FunctionalState) (((((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO0IntStatR)>>pinNum)& 0x1);
	else if ((portNum == 2) && (edgeState == 0))
		return(FunctionalState) (((((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO2IntStatR)>>pinNum)& 0x1);
	
	
	else if ((portNum == 0) && (edgeState == 1))
		return (FunctionalState)(((((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO0IntStatF)>>pinNum)& 0x1);
	else if ((portNum == 2) && (edgeState == 1))
		return (FunctionalState)(((((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO2IntStatF)>>pinNum)& 0x1);
	else
...
{
	if(portNum == 0)
		((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO0IntClr = bitValue;
	else if (portNum == 2)
		((LPC_GPIOINT_TypeDef *) ((0x40000000UL) + 0x28080) )->IO2IntClr = bitValue;
	else
