...
typedef xQUEUE Queue_t;
    ...
    typedef xQueueRegistryItem QueueRegistryItem_t;
     ...
     QueueRegistryItem_t xQueueRegistry[ 10 ];
                               ...
                               BaseType_t xNewQueue )
{
    ...
    if((pxQueue)==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",269);
...
#line 378 "FreeRTOS\\queue.c"
                                       ...
                                       const uint8_t ucQueueType )
    {
        ...
        if((uxQueueLength > ( UBaseType_t ) 0)==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",390);
        ...
        if((( uxItemSize == 0 ) || ( uxQueueLength == ( xQueueSizeInBytes / uxItemSize ) ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",398);

         
        if((( sizeof( Queue_t ) + xQueueSizeInBytes ) > xQueueSizeInBytes)==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",401);
...
#line 555 "FreeRTOS\\queue.c"
 

#line 586 "FreeRTOS\\queue.c"
 

#line 612 "FreeRTOS\\queue.c"
    ...
    BaseType_t xQueueGiveMutexRecursive( QueueHandle_t xMutex )
    {
        ...
        if((pxMutex)==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",621);
...
#line 740 "FreeRTOS\\queue.c"
                                                 ...
                                                 const UBaseType_t uxInitialCount )
    {
        ...
        if((uxMaxCount != 0)==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",749);
        if((uxInitialCount <= uxMaxCount)==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",750);
                              ...
                              const BaseType_t xCopyPosition )
{
    ...
    if((pxQueue)==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",780);
    if((!( ( pvItemToQueue == 0 ) && ( pxQueue ->uxItemSize != ( UBaseType_t ) 0U ) ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",781);
    if((!( ( xCopyPosition == ( ( BaseType_t ) 2 ) ) && ( pxQueue ->uxLength != 1 ) ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",782);

        {
            if((!( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",785);
        }
                                     ...
                                     const BaseType_t xCopyPosition )
{
    ...
    if((pxQueue)==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",992);
    if((!( ( pvItemToQueue == 0 ) && ( pxQueue ->uxItemSize != ( UBaseType_t ) 0U ) ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",993);
    if((!( ( xCopyPosition == ( ( BaseType_t ) 2 ) ) && ( pxQueue ->uxLength != 1 ) ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",994);
...
#line 1126 "FreeRTOS\\queue.c"
            }
            else
            {
                
 
                if((cTxLock != ( ( int8_t ) 127 ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1131);
                              ...
                              BaseType_t * const pxHigherPriorityTaskWoken )
{
    ...
    if((pxQueue)==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1163);

    
 
    if((pxQueue ->uxItemSize == 0)==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1167);

    

 
    if((!( ( pxQueue ->pcHead == 0 ) && ( pxQueue ->u . xSemaphore . xMutexHolder != 0 ) ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1172);
...
#line 1294 "FreeRTOS\\queue.c"
            }
            else
            {
                
 
                if((cTxLock != ( ( int8_t ) 127 ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1299);
                          ...
                          TickType_t xTicksToWait )
{
    ...
    if((( pxQueue ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1327);

    
 
    if((!( ( ( pvBuffer ) == 0 ) && ( ( pxQueue )->uxItemSize != ( UBaseType_t ) 0U ) ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1331);

     

        {
            if((!( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1336);
        }
                                ...
                                TickType_t xTicksToWait )
{
    ...
    if((( pxQueue ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1473);

    
 
    if((pxQueue ->uxItemSize == 0)==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1477);

     

        {
            if((!( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1482);
        }
        ...
        vPortEnterCritical();
        {
            ...
            else
            {
                if( xTicksToWait == ( TickType_t ) 0 )
                {
                        ...
                        {
                            if((xInheritanceOccurred == ( ( BaseType_t ) 0 ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1552);
                        }
                       ...
                       TickType_t xTicksToWait )
{
    ...
    if((( pxQueue ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1690);

    
 
    if((!( ( ( pvBuffer ) == 0 ) && ( ( pxQueue )->uxItemSize != ( UBaseType_t ) 0U ) ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1694);

     

        {
            if((!( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1699);
        }
                                 ...
                                 BaseType_t * const pxHigherPriorityTaskWoken )
{
    ...
    if((pxQueue)==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1839);
    if((!( ( pvBuffer == 0 ) && ( pxQueue ->uxItemSize != ( UBaseType_t ) 0U ) ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1840);
    ...
    uxSavedInterruptStatus = ulPortRaiseBASEPRI();
    {
        ...
        if( uxMessagesWaiting > ( UBaseType_t ) 0 )
        {
            ...
            else
            {
                ...
                if((cRxLock != ( ( int8_t ) 127 ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1907);
                              ...
                              void * const pvBuffer )
{
    ...
    if((pxQueue)==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1934);
    if((!( ( pvBuffer == 0 ) && ( pxQueue ->uxItemSize != ( UBaseType_t ) 0U ) ))==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1935);
    if((pxQueue ->uxItemSize != 0)==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1936);  
...
UBaseType_t uxQueueMessagesWaiting( const QueueHandle_t xQueue )
{
    ...
    if((xQueue)==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",1985);
...
#line 2065 "FreeRTOS\\queue.c"
}
 

#line 2076 "FreeRTOS\\queue.c"
 

#line 2087 "FreeRTOS\\queue.c"
 

#line 2097 "FreeRTOS\\queue.c"
...
#line 2509 "FreeRTOS\\queue.c"
 

#line 2603 "FreeRTOS\\queue.c"
 

#line 2653 "FreeRTOS\\queue.c"
 

#line 2717 "FreeRTOS\\queue.c"
                              ...
                              const char * pcQueueName )  
    {
        ...
        for( ux = ( UBaseType_t ) 0U; ux < ( UBaseType_t ) 10; ux++ )
        {
...
#line 2847 "FreeRTOS\\queue.c"
    ...
    static BaseType_t prvNotifyQueueSetContainer( const Queue_t * const pxQueue )
    {
        ...
        if((pxQueueSetContainer)==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",2970);
        if((pxQueueSetContainer->uxMessagesWaiting < pxQueueSetContainer->uxLength)==0) printf("Error:%s,%d\r\n","FreeRTOS\\queue.c",2971);
