#line 1 "..\\Lwip\\core\\inet_chksum.c"
...
#line 49 "..\\Lwip\\core\\inet_chksum.c"
...
#line 51 "..\\Lwip\\core\\inet_chksum.c"
#line 52 "..\\Lwip\\core\\inet_chksum.c"
#line 53 "..\\Lwip\\core\\inet_chksum.c"
...
#line 55 "..\\Lwip\\core\\inet_chksum.c"
...
#line 116 "..\\Lwip\\core\\inet_chksum.c"
...
lwip_standard_chksum(const void *dataptr, int len)
{
  ...
  sum = ((u32_t)(((sum) >> 16) + ((sum) & 0x0000ffffUL)));
  sum = ((u32_t)(((sum) >> 16) + ((sum) & 0x0000ffffUL)));
...
#line 257 "..\\Lwip\\core\\inet_chksum.c"
...
inet_cksum_pseudo_base(struct pbuf *p, u8_t proto, u16_t proto_len, u32_t acc)
{
  ...
  for (q = p; q != 0; q = q->next) {
    ...
    acc = ((u32_t)(((acc) >> 16) + ((acc) & 0x0000ffffUL)));
    if (q->len % 2 != 0) {
      swapped = !swapped;
...
#line 365 "..\\Lwip\\core\\inet_chksum.c"
...
ip_chksum_pseudo(struct pbuf *p, u8_t proto, u16_t proto_len,
                 const ip_addr_t *src, const ip_addr_t *dest)
{
#line 391 "..\\Lwip\\core\\inet_chksum.c"
  {
                               ...
                               u16_t chksum_len, u32_t acc)
{
  ...
  for (q = p; (q != 0) && (chksum_len > 0); q = q->next) {
    ...
    do { if (!(chksum_len < 0x7fff)) { do {printf("delete me");}while(0); }} while(0);
...
#line 513 "..\\Lwip\\core\\inet_chksum.c"
...
ip_chksum_pseudo_partial(struct pbuf *p, u8_t proto, u16_t proto_len,
                         u16_t chksum_len, const ip_addr_t *src, const ip_addr_t *dest)
{
#line 538 "..\\Lwip\\core\\inet_chksum.c"
  {
