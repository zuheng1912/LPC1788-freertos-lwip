...
#line 44 "..\\Lwip\\api\\tcpip.c"
#line 45 "..\\Lwip\\api\\tcpip.c"
#line 46 "..\\Lwip\\api\\tcpip.c"
#line 47 "..\\Lwip\\api\\tcpip.c"
...
#line 49 "..\\Lwip\\api\\tcpip.c"
#line 50 "..\\Lwip\\api\\tcpip.c"
...
tcpip_thread(void *arg)
{
  ...
  while (1) {                           
    ...
    if (msg == 0) {
      ;
      do { if (!(0)) { do {printf("tcpip_thread: invalid message");}while(0); }} while(0);      
      continue;
    }
...
{
#line 250 "..\\Lwip\\api\\tcpip.c"
  struct tcpip_msg *msg;

  do { if (!(sys_mbox_valid(&(tcpip_mbox)))) { do {printf("Invalid mbox");}while(0); }} while(0);
...
tcpip_init(tcpip_init_done_fn initfunc, void *arg)
{
  ...
  if (sys_mbox_new(&tcpip_mbox, 8) != ERR_OK) {
    do { if (!(0)) { do {printf("failed to create tcpip_thread mbox");}while(0); }} while(0);
  }

  if (sys_mutex_new(&lock_tcpip_core) != ERR_OK) {
    do { if (!(0)) { do {printf("failed to create lock_tcpip_core");}while(0); }} while(0);
  }


  sys_thread_new("lwip", tcpip_thread, 0, 512, 6);
}
