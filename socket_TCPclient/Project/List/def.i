...
lwip_htons(u16_t n)
{
  return ((u16_t)((((n) & (u16_t)0x00ffU) << 8) | (((n) & (u16_t)0xff00U) >> 8)));
}
...
lwip_htonl(u32_t n)
{
  return ((((n) & (u32_t)0x000000ffUL) << 24) | (((n) & (u32_t)0x0000ff00UL) << 8) | (((n) & (u32_t)0x00ff0000UL) >> 8) | (((n) & (u32_t)0xff000000UL) >> 24));
}
