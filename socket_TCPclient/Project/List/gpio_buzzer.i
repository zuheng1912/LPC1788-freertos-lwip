...
#line 16 "..\\User\\GPIO_Buzzer.c"
#line 17 "..\\User\\GPIO_Buzzer.c"
#line 18 "..\\User\\GPIO_Buzzer.c"
...
void init (void)
{
	uint32_t cclk = CLKPWR_GetCLK(((uint32_t)(0)));
...
static void led_task(void* parameter)
{
	...
	while (1)
	{
		...
		GPIO_OutputValue((2), (1 << (26)), value);
		GPIO_OutputValue((2), (1 << (23)), value);
		value = !value;
		vTaskDelay(500);;
	}   
}
