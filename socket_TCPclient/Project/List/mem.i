...
#line 60 "..\\Lwip\\core\\mem.c"
#line 61 "..\\Lwip\\core\\mem.c"
#line 62 "..\\Lwip\\core\\mem.c"
...
#line 85 "..\\Lwip\\core\\mem.c"

#line 153 "..\\Lwip\\core\\mem.c"

#line 175 "..\\Lwip\\core\\mem.c"

#line 342 "..\\Lwip\\core\\mem.c"
...
u8_t ram_heap[(((((((25*1024)) + 4 - 1U) & ~(4-1U)) + (2U * (((sizeof(struct mem)) + 4 - 1U) & ~(4-1U)))) + 4 - 1U))];
...
#line 429 "..\\Lwip\\core\\mem.c"

#line 449 "..\\Lwip\\core\\mem.c"
...
plug_holes(struct mem *mem)
{
  ...
  do { if (!((u8_t *)mem >= ram)) { do {printf("plug_holes: mem >= ram");}while(0); }} while(0);
  do { if (!((u8_t *)mem < (u8_t *)ram_end)) { do {printf("plug_holes: mem < ram_end");}while(0); }} while(0);
  do { if (!(mem->used == 0)) { do {printf("plug_holes: mem->used == 0");}while(0); }} while(0);

   
  do { if (!(mem->next <= ((((25*1024)) + 4 - 1U) & ~(4-1U)))) { do {printf("plug_holes: mem->next <= MEM_SIZE_ALIGNED");}while(0); }} while(0);
  ...
  if (mem != nmem && nmem->used == 0 && (u8_t *)nmem != (u8_t *)ram_end) {
    ...
    mem->next = nmem->next;
    if (nmem->next != ((((25*1024)) + 4 - 1U) & ~(4-1U))) {
...
mem_init(void)
{
  ...
  do { if (!(((((sizeof(struct mem)) + 4 - 1U) & ~(4-1U)) & (4 - 1)) == 0)) { do {printf("Sanity check alignment");}while(0); }} while(0);
  ...
  mem->next = ((((25*1024)) + 4 - 1U) & ~(4-1U));
  mem->prev = 0;
  mem->used = 0;
   
  ram_end = ptr_to_mem(((((25*1024)) + 4 - 1U) & ~(4-1U)));
  ram_end->used = 1;
  ram_end->next = ((((25*1024)) + 4 - 1U) & ~(4-1U));
  ram_end->prev = ((((25*1024)) + 4 - 1U) & ~(4-1U));
  ;
  ...
  if (sys_mutex_new(&mem_mutex) != ERR_OK) {
    do { if (!(0)) { do {printf("failed to create mem_mutex");}while(0); }} while(0);
  }
}
...
mem_link_valid(struct mem *mem)
{
  ...
  nmem = ptr_to_mem(mem->next);
  pmem = ptr_to_mem(mem->prev);
  if ((mem->next > ((((25*1024)) + 4 - 1U) & ~(4-1U))) || (mem->prev > ((((25*1024)) + 4 - 1U) & ~(4-1U))) ||
...
mem_free(void *rmem)
{
  ...
  if ((((mem_ptr_t)rmem) & (4 - 1)) != 0) {
    do { if (!(0)) { do {printf("mem_free: sanity check alignment");}while(0); }} while(0);
    ;
     
    do { sys_prot_t old_level; old_level = sys_arch_protect(); ; sys_arch_unprotect(old_level); } while(0);
    return;
  }
  ...
  if ((u8_t *)mem < ram || (u8_t *)rmem + (((12) + 4 - 1U) & ~(4-1U)) > (u8_t *)ram_end) {
    do { if (!(0)) { do {printf("mem_free: illegal memory");}while(0); }} while(0);
    ;
  ...
  if (!mem->used) {
    do { if (!(0)) { do {printf("mem_free: illegal memory: double free");}while(0); }} while(0);
  ...
  if (!mem_link_valid(mem)) {
    do { if (!(0)) { do {printf("mem_free: illegal memory: non-linked: double free");}while(0); }} while(0);
    sys_mutex_unlock(&mem_mutex);
    ;
...
mem_trim(void *rmem, mem_size_t new_size)
{
  ...
  if ((newsize > ((((25*1024)) + 4 - 1U) & ~(4-1U))) || (newsize < new_size)) {
    return 0;
  }

  do { if (!((u8_t *)rmem >= (u8_t *)ram && (u8_t *)rmem < (u8_t *)ram_end)) { do {printf("mem_trim: legal memory");}while(0); }} while(0);
  ...
  do { if (!(newsize <= size)) { do {printf("mem_trim can only shrink memory");}while(0); }} while(0);
  if (newsize > size) {
  ...
  if (mem2->used == 0) {
    ...
    mem_size_t next;
    do { if (!(mem->next != ((((25*1024)) + 4 - 1U) & ~(4-1U)))) { do {printf("invalid next ptr");}while(0); }} while(0);
    ...
    if (mem2->next != ((((25*1024)) + 4 - 1U) & ~(4-1U))) {
...
mem_malloc(mem_size_t size_in)
{
  ...
  if ((size > ((((25*1024)) + 4 - 1U) & ~(4-1U))) || (size < size_in)) {
    return 0;
  }
  ...
  ;
    ...
    for (ptr = mem_to_ptr(lfree); ptr < ((((25*1024)) + 4 - 1U) & ~(4-1U)) - size;
         ptr = ptr_to_mem(ptr)->next) {
      mem = ptr_to_mem(ptr);
#line 886 "..\\Lwip\\core\\mem.c"
      ...
      if ((!mem->used) &&
        ...
        if (mem->next - (ptr + (((sizeof(struct mem)) + 4 - 1U) & ~(4-1U))) >= (size + (((sizeof(struct mem)) + 4 - 1U) & ~(4-1U)) + (((12) + 4 - 1U) & ~(4-1U)))) {
          ...
          do { if (!(ptr2 != ((((25*1024)) + 4 - 1U) & ~(4-1U)))) { do {printf("invalid next ptr");}while(0); }} while(0);
...
#line 947 "..\\Lwip\\core\\mem.c"
            cur = ptr_to_mem(cur->next);
          }
          lfree = cur;
          do { if (!(((lfree == ram_end) || (!lfree ->used)))) { do {printf("mem_malloc: !lfree->used");}while(0); }} while(0);
        }
        ;
        sys_mutex_unlock(&mem_mutex);
        do { if (!((mem_ptr_t)mem + (((sizeof(struct mem)) + 4 - 1U) & ~(4-1U)) + size <= (mem_ptr_t)ram_end)) { do {printf("mem_malloc: allocated memory not above ram_end.");}while(0); }} while(0);

        do { if (!(((mem_ptr_t)mem + (((sizeof(struct mem)) + 4 - 1U) & ~(4-1U))) % 4 == 0)) { do {printf("mem_malloc: allocated memory properly aligned.");}while(0); }} while(0);

        do { if (!((((mem_ptr_t)mem) & (4 - 1)) == 0)) { do {printf("mem_malloc: sanity check alignment");}while(0); }} while(0);
