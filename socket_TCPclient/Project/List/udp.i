...
#line 53 "..\\Lwip\\core\\udp.c"
#line 54 "..\\Lwip\\core\\udp.c"
#line 55 "..\\Lwip\\core\\udp.c"
...
#line 56 "..\\Lwip\\core\\udp.c"
#line 57 "..\\Lwip\\core\\udp.c"
#line 58 "..\\Lwip\\core\\udp.c"
#line 59 "..\\Lwip\\core\\udp.c"
#line 60 "..\\Lwip\\core\\udp.c"
...
#line 61 "..\\Lwip\\core\\udp.c"
#line 1 "..\\Lwip\\include\\lwip/icmp6.h"
...
#line 45 "..\\Lwip\\include\\lwip/icmp6.h"
#line 46 "..\\Lwip\\include\\lwip/icmp6.h"
#line 47 "..\\Lwip\\include\\lwip/icmp6.h"
#line 48 "..\\Lwip\\include\\lwip/icmp6.h"
#line 1 "..\\Lwip\\include\\lwip/prot/icmp6.h"
...
#line 41 "..\\Lwip\\include\\lwip/prot/icmp6.h"
...
#line 49 "..\\Lwip\\include\\lwip/icmp6.h"





#line 65 "..\\Lwip\\include\\lwip/icmp6.h"
...
#line 62 "..\\Lwip\\core\\udp.c"
#line 63 "..\\Lwip\\core\\udp.c"
#line 1 "..\\Lwip\\include\\lwip/snmp.h"
...
#line 41 "..\\Lwip\\include\\lwip/snmp.h"
#line 42 "..\\Lwip\\include\\lwip/snmp.h"
...
#line 142 "..\\Lwip\\include\\lwip/snmp.h"

 
#line 173 "..\\Lwip\\include\\lwip/snmp.h"
...
#line 208 "..\\Lwip\\include\\lwip/snmp.h"





#line 64 "..\\Lwip\\core\\udp.c"
...
udp_input_local_match(struct udp_pcb *pcb, struct netif *inp, u8_t broadcast)
{
  ...
  do { if (!(pcb != 0)) { do {printf("udp_input_local_match: invalid pcb");}while(0); }} while(0);
  do { if (!(inp != 0)) { do {printf("udp_input_local_match: invalid netif");}while(0); }} while(0);
...
udp_input(struct pbuf *p, struct netif *inp)
{
  ...
  do { if (!(p != 0)) { do {printf("udp_input: invalid pbuf");}while(0); }} while(0);
  do { if (!(inp != 0)) { do {printf("udp_input: invalid netif");}while(0); }} while(0);
  ...
  for (pcb = udp_pcbs; pcb != 0; pcb = pcb->next) {
    ...
    if ((pcb->local_port == dest) &&
      ...
      if ((pcb->flags & 0x04U) == 0) {
        ...
        } else if (broadcast && (&ip_data . current_iphdr_dest)->addr == ((u32_t)0xffffffffUL)) {
           
          if (!1 || !(((&uncon_pcb->local_ip))->addr == (((const ip4_addr_t*)(&((inp)->ip_addr))))->addr)) {
             
            if (1 && (((&pcb->local_ip))->addr == (((const ip4_addr_t*)(&((inp)->ip_addr))))->addr)) {
...
#line 323 "..\\Lwip\\core\\udp.c"
  ...
  if (for_us) {
    ;
#line 366 "..\\Lwip\\core\\udp.c"
    if (pbuf_remove_header(p, 8)) {
       
      do { if (!(0)) { do {printf("pbuf_remove_header failed\n");}while(0); }} while(0);
      ;
      ;
      pbuf_free(p);
      goto end;
...
{
  do { if (!(pcb != 0)) { do {printf("udp_send: invalid pcb");}while(0); return ERR_ARG;}} while(0);
  do { if (!(p != 0)) { do {printf("udp_send: invalid pbuf");}while(0); return ERR_ARG;}} while(0);
...
udp_sendto(struct udp_pcb *pcb, struct pbuf *p,
           const ip_addr_t *dst_ip, u16_t dst_port)
{
#line 534 "..\\Lwip\\core\\udp.c"
  struct netif *netif;

  do { if (!(pcb != 0)) { do {printf("udp_sendto: invalid pcb");}while(0); return ERR_ARG;}} while(0);
  do { if (!(p != 0)) { do {printf("udp_sendto: invalid pbuf");}while(0); return ERR_ARG;}} while(0);
  do { if (!(dst_ip != 0)) { do {printf("udp_sendto: invalid dst_ip");}while(0); return ERR_ARG;}} while(0);
...
#line 582 "..\\Lwip\\core\\udp.c"
    {
       
      netif = ip4_route(dst_ip);
    }
  }
...
{
#line 638 "..\\Lwip\\core\\udp.c"
  const ip_addr_t *src_ip;

  do { if (!(pcb != 0)) { do {printf("udp_sendto_if: invalid pcb");}while(0); return ERR_ARG;}} while(0);
  do { if (!(p != 0)) { do {printf("udp_sendto_if: invalid pbuf");}while(0); return ERR_ARG;}} while(0);
  do { if (!(dst_ip != 0)) { do {printf("udp_sendto_if: invalid dst_ip");}while(0); return ERR_ARG;}} while(0);
  do { if (!(netif != 0)) { do {printf("udp_sendto_if: invalid netif");}while(0); return ERR_ARG;}} while(0);
...
#line 673 "..\\Lwip\\core\\udp.c"
    if ((((&pcb->local_ip)) == 0 || ((*((&pcb->local_ip))). addr == ((u32_t)0x00000000UL))) ||
        ((((&pcb->local_ip))->addr & ((((0xf0000000UL) & (u32_t)0x000000ffUL) << 24) | (((0xf0000000UL) & (u32_t)0x0000ff00UL) << 8) | (((0xf0000000UL) & (u32_t)0x00ff0000UL) >> 8) | (((0xf0000000UL) & (u32_t)0xff000000UL) >> 24))) == ((((0xe0000000UL) & (u32_t)0x000000ffUL) << 24) | (((0xe0000000UL) & (u32_t)0x0000ff00UL) << 8) | (((0xe0000000UL) & (u32_t)0x00ff0000UL) >> 8) | (((0xe0000000UL) & (u32_t)0xff000000UL) >> 24)))) {
...
#line 713 "..\\Lwip\\core\\udp.c"
  ...
  do { if (!(pcb != 0)) { do {printf("udp_sendto_if_src: invalid pcb");}while(0); return ERR_ARG;}} while(0);
  do { if (!(p != 0)) { do {printf("udp_sendto_if_src: invalid pbuf");}while(0); return ERR_ARG;}} while(0);
  do { if (!(dst_ip != 0)) { do {printf("udp_sendto_if_src: invalid dst_ip");}while(0); return ERR_ARG;}} while(0);
  do { if (!(src_ip != 0)) { do {printf("udp_sendto_if_src: invalid src_ip");}while(0); return ERR_ARG;}} while(0);
  do { if (!(netif != 0)) { do {printf("udp_sendto_if_src: invalid netif");}while(0); return ERR_ARG;}} while(0);
...
#line 744 "..\\Lwip\\core\\udp.c"
  ...
  if ((u16_t)(p->tot_len + 8) < p->tot_len) {
    return ERR_MEM;
  }
   
  if (pbuf_add_header(p, 8)) {
  ...
  do { if (!((q->len >= sizeof(struct udp_hdr)))) { do {printf("check that first pbuf can hold struct udp_hdr");}while(0); }} while(0);
...
#line 848 "..\\Lwip\\core\\udp.c"
  {       
    ;
    udphdr->len = lwip_htons(q->tot_len);
     
#line 879 "..\\Lwip\\core\\udp.c"
    ip_proto = 17;
  }
...
udp_bind(struct udp_pcb *pcb, const ip_addr_t *ipaddr, u16_t port)
{
  ...
  do { if (!(pcb != 0)) { do {printf("udp_bind: invalid pcb");}while(0); return ERR_ARG;}} while(0);
      ...
      if (pcb != ipcb) {
...

        {
          ...
          if ((ipcb->local_port == port) &&
              ...
              (((&ipcb->local_ip)->addr == (ipaddr)->addr) || ((ipaddr) == 0 || ((*(ipaddr)). addr == ((u32_t)0x00000000UL))) ||
...
udp_connect(struct udp_pcb *pcb, const ip_addr_t *ipaddr, u16_t port)
{
  ...
  do { if (!(pcb != 0)) { do {printf("udp_connect: invalid pcb");}while(0); return ERR_ARG;}} while(0);
  do { if (!(ipaddr != 0)) { do {printf("udp_connect: invalid ipaddr");}while(0); return ERR_ARG;}} while(0);
...
udp_disconnect(struct udp_pcb *pcb)
{
  ...
  do { if (!(pcb != 0)) { do {printf("udp_disconnect: invalid pcb");}while(0); return;}} while(0);
  ...
  do { (pcb)->flags = (u8_t)((pcb)->flags & (u8_t)(~(0x04U) & 0xff)); } while(0);
}
...
udp_recv(struct udp_pcb *pcb, udp_recv_fn recv, void *recv_arg)
{
  ...
  do { if (!(pcb != 0)) { do {printf("udp_recv: invalid pcb");}while(0); return;}} while(0);
...
udp_remove(struct udp_pcb *pcb)
{
  ...
  do { if (!(pcb != 0)) { do {printf("udp_remove: invalid pcb");}while(0); return;}} while(0);
