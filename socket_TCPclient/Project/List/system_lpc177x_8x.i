#line 1 "..\\..\\Core\\CM3\\DeviceSupport\\NXP\\LPC177x_8x\\system_LPC177x_8x.c"
...
#line 34 "..\\..\\Core\\CM3\\DeviceSupport\\NXP\\LPC177x_8x\\system_LPC177x_8x.c"
...
#line 35 "..\\..\\Core\\CM3\\DeviceSupport\\NXP\\LPC177x_8x\\system_LPC177x_8x.c"
...
#line 36 "..\\..\\Core\\CM3\\DeviceSupport\\NXP\\LPC177x_8x\\system_LPC177x_8x.c"
...
#line 202 "..\\..\\Core\\CM3\\DeviceSupport\\NXP\\LPC177x_8x\\system_LPC177x_8x.c"
...
#line 315 "..\\..\\Core\\CM3\\DeviceSupport\\NXP\\LPC177x_8x\\system_LPC177x_8x.c"
...
uint32_t SystemCoreClock = ((( (12000000UL)) * ((0x00000009 & 0x1F) + 1)) / ((0x00000001|(1<<8)) & 0x1F)); 
uint32_t PeripheralClock = ((( (12000000UL)) * ((0x00000009 & 0x1F) + 1)) / (0x00000002 & 0x1F));  
uint32_t EMCClock		 = ((( (12000000UL)) * ((0x00000009 & 0x1F) + 1)) / ((0x00000001 & 0x01) + 1));  
...
void SystemCoreClockUpdate (void)             
{
  ...
  if ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CCLKSEL &0x100) == 0) {             
    if ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CLKSRCSEL & 0x01) == 0) {     
          SystemCoreClock = ((12000000UL) / (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CCLKSEL & 0x1F));
          PeripheralClock = ((12000000UL) / (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL & 0x1F));
          EMCClock        = ((12000000UL) / ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EMCCLKSEL & 0x01)+1));
    }
    else {                                         
      if ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->SCS & 0x40) == 0) {
          SystemCoreClock = 0;                       
          PeripheralClock = 0;
          EMCClock        = 0;
      }
    ...
    if ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0STAT & 0x100) == 0) {         
          SystemCoreClock = 0;                       
          PeripheralClock = 0;
          EMCClock 		  = 0;
    }
      ...
      if ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CLKSRCSEL & 0x01) == 0) {     
          SystemCoreClock = ((12000000UL) * ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0STAT & 0x1F) + 1) / (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CCLKSEL & 0x1F));
          PeripheralClock = ((12000000UL) * ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0STAT & 0x1F) + 1) / (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL & 0x1F));
          EMCClock        = ((12000000UL) * ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0STAT & 0x1F) + 1) / ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EMCCLKSEL & 0x01)+1));
      }
      else {                                         
        if ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->SCS & 0x40) == 0) {
          SystemCoreClock = 0;                       
  ...
  if(((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->USBCLKSEL & (0x01<<8))
  {
	  switch (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->USBCLKSEL & 0x1F)
	  {
	  case 0:
		  USBClock = 0; 
		  break;
	  case 4:
	  case 6:
		  if(((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CLKSRCSEL & 0x01)	
			  USBClock = (( (12000000UL)) * ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0STAT & 0x1F) + 1) / (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->USBCLKSEL & 0x1F));
		  else 
			  USBClock = ((12000000UL) * ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0STAT & 0x1F) + 1) / (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->USBCLKSEL & 0x1F));
		  break;
	  default:
  ...
  else if(((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->USBCLKSEL & (0x02<<8))
  {
	  if(((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CLKSRCSEL & 0x01)	
	  		USBClock = (( (12000000UL)) * ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL1STAT & 0x1F) + 1));
	  else 
	  		USBClock = ((12000000UL) * ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0STAT & 0x1F) + 1));
  }
  else
	  USBClock = 0;  
}
...
void SystemInit (void)
{
  ...
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->SCS       = 0x00000021;
  if (0x00000021 & (1 << 5)) {              
  ...
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0CFG   = 0x00000009;
  ...
  while (!(((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0STAT & (1<<10))); 
  ...
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CCLKSEL   = (0x00000001|(1<<8));       
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->USBCLKSEL = (0x00000001|(0x02<<8));     
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EMCCLKSEL = 0x00000001;     
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL   = 0x00000002;       
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP     = 0x042887DE;         
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CLKOUTCFG = 0x00000100;     



  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->FLASHCFG  = 0x00005000|0x03A;




  ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL))->VTOR  = 0x00000000 & 0x3FFFFF80;
