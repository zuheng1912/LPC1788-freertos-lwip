...
#line 46 "..\\Lwip\\core\\ipv4\\ip4.c"
#line 47 "..\\Lwip\\core\\ipv4\\ip4.c"
#line 48 "..\\Lwip\\core\\ipv4\\ip4.c"
...
#line 50 "..\\Lwip\\core\\ipv4\\ip4.c"
#line 51 "..\\Lwip\\core\\ipv4\\ip4.c"
...
#line 53 "..\\Lwip\\core\\ipv4\\ip4.c"
#line 1 "..\\Lwip\\include\\lwip/priv/raw_priv.h"
...
#line 41 "..\\Lwip\\include\\lwip/priv/raw_priv.h"

#line 68 "..\\Lwip\\include\\lwip/priv/raw_priv.h"

#line 54 "..\\Lwip\\core\\ipv4\\ip4.c"
...
#line 57 "..\\Lwip\\core\\ipv4\\ip4.c"
#line 58 "..\\Lwip\\core\\ipv4\\ip4.c"
...
#line 122 "..\\Lwip\\core\\ipv4\\ip4.c"

#line 141 "..\\Lwip\\core\\ipv4\\ip4.c"
...
#line 202 "..\\Lwip\\core\\ipv4\\ip4.c"

#line 215 "..\\Lwip\\core\\ipv4\\ip4.c"

  if ((netif_default == 0) || !(((netif_default)->flags & 0x01U) ? (u8_t)1 : (u8_t)0) || !(((netif_default)->flags & 0x04U) ? (u8_t)1 : (u8_t)0) ||
      ((*((const ip4_addr_t*)(&((netif_default)->ip_addr)))). addr == ((u32_t)0x00000000UL)) || (((dest)->addr & ((((0xff000000) & (u32_t)0x000000ffUL) << 24) | (((0xff000000) & (u32_t)0x0000ff00UL) << 8) | (((0xff000000) & (u32_t)0x00ff0000UL) >> 8) | (((0xff000000) & (u32_t)0xff000000UL) >> 24))) == ((((((u32_t)127) << 24) & (u32_t)0x000000ffUL) << 24) | (((((u32_t)127) << 24) & (u32_t)0x0000ff00UL) << 8) | (((((u32_t)127) << 24) & (u32_t)0x00ff0000UL) >> 8) | (((((u32_t)127) << 24) & (u32_t)0xff000000UL) >> 24)))) {
...
#line 462 "..\\Lwip\\core\\ipv4\\ip4.c"

   
  iphdr_hlen = ((u8_t)(((iphdr)->_v_hl & 0x0f) * 4));
...
#line 534 "..\\Lwip\\core\\ipv4\\ip4.c"
    ...
    if (ip4_input_accept(inp)) {
      ...
      if (!((((&ip_data . current_iphdr_dest))->addr & ((((0xff000000) & (u32_t)0x000000ffUL) << 24) | (((0xff000000) & (u32_t)0x0000ff00UL) << 8) | (((0xff000000) & (u32_t)0x00ff0000UL) >> 8) | (((0xff000000) & (u32_t)0xff000000UL) >> 24))) == ((((((u32_t)127) << 24) & (u32_t)0x000000ffUL) << 24) | (((((u32_t)127) << 24) & (u32_t)0x0000ff00UL) << 8) | (((((u32_t)127) << 24) & (u32_t)0x00ff0000UL) >> 8) | (((((u32_t)127) << 24) & (u32_t)0xff000000UL) >> 24))))
  ...
  if (netif == 0) {
    ...
    if (((iphdr)->_proto) == 17) {
      ...
      if (((udphdr->dest) == ((u16_t)((((LWIP_IANA_PORT_DHCP_CLIENT) & (u16_t)0x00ffU) << 8) | (((LWIP_IANA_PORT_DHCP_CLIENT) & (u16_t)0xff00U) >> 8))))) {
        ;
        netif = inp;
        check_ip_src = 0;
      }
...

  {
    if ((ip4_addr_isbroadcast_u32(((&ip_data . current_iphdr_src))->addr, inp)) ||
        (((((&ip_data . current_iphdr_src))->addr & ((((0xf0000000UL) & (u32_t)0x000000ffUL) << 24) | (((0xf0000000UL) & (u32_t)0x0000ff00UL) << 8) | (((0xf0000000UL) & (u32_t)0x00ff0000UL) >> 8) | (((0xf0000000UL) & (u32_t)0xff000000UL) >> 24))) == ((((0xe0000000UL) & (u32_t)0x000000ffUL) << 24) | (((0xe0000000UL) & (u32_t)0x0000ff00UL) << 8) | (((0xe0000000UL) & (u32_t)0x00ff0000UL) >> 8) | (((0xe0000000UL) & (u32_t)0xff000000UL) >> 24))))) {
...
#line 628 "..\\Lwip\\core\\ipv4\\ip4.c"
  ...
  if ((((iphdr)->_offset) & ((u16_t)((((0x1fffU | 0x2000U) & (u16_t)0x00ffU) << 8) | (((0x1fffU | 0x2000U) & (u16_t)0xff00U) >> 8)))) != 0) {
...
#line 658 "..\\Lwip\\core\\ipv4\\ip4.c"
  }

#line 677 "..\\Lwip\\core\\ipv4\\ip4.c"
  ...
  ip_data.current_ip_header_tot_len = ((u8_t)(((iphdr)->_v_hl & 0x0f) * 4));
...
#line 845 "..\\Lwip\\core\\ipv4\\ip4.c"
  ...
  ;
  do { if (!((p)->ref == 1)) { do {printf("p->ref == 1");}while(0); }} while(0);
...
#line 894 "..\\Lwip\\core\\ipv4\\ip4.c"
    ...
    iphdr = (struct ip_hdr *)p->payload;
    do { if (!((p->len >= sizeof(struct ip_hdr)))) { do {printf("check that first pbuf can hold struct ip_hdr");}while(0); }} while(0);
...
#line 958 "..\\Lwip\\core\\ipv4\\ip4.c"
    (iphdr)->_chksum = (0);
#line 965 "..\\Lwip\\core\\ipv4\\ip4.c"
  } else {
...
#line 1000 "..\\Lwip\\core\\ipv4\\ip4.c"
...
#line 1087 "..\\Lwip\\core\\ipv4\\ip4.c"

#line 1131 "..\\Lwip\\core\\ipv4\\ip4.c"
