#line 1 "..\\..\\Drivers\\source\\lpc177x_8x_clkpwr.c"
...
#line 34 "..\\..\\Drivers\\source\\lpc177x_8x_clkpwr.c"
...
void CLKPWR_SetCLKDiv (uint8_t ClkType, uint8_t DivVal)
{
	...
	{
	case ((uint32_t)(0)):
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CCLKSEL = DivVal;
		SystemCoreClockUpdate(); 
		break;
	case ((uint32_t)(1)):
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL = DivVal;
		SystemCoreClockUpdate(); 
		break;
	case ((uint32_t)(2)):
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EMCCLKSEL = DivVal;
		SystemCoreClockUpdate(); 
		break;
	case ((uint32_t)(3)):
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->USBCLKSEL &= ~(0x0000001F);
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->USBCLKSEL |= DivVal;
		break;
	default:
		while(1);
	}
...
void CLKPWR_ConfigPPWR (uint32_t PPType, FunctionalState NewState)
{
	if (NewState == ENABLE)
	{
		((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP |= PPType;
	}
...
#line 235 "..\\..\\Drivers\\source\\lpc177x_8x_clkpwr.c"
...
void CLKPWR_Sleep(void)
{
	((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCON = 0x00;
...
void CLKPWR_DeepSleep(void)
{
	...
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL))->SCR = 0x4;
	((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCON = 0x8;
...
void CLKPWR_PowerDown(void)
{
	...
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL))->SCR = 0x4;
	((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCON = 0x09;
...
void CLKPWR_DeepPowerDown(void)
{
	...
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL))->SCR = 0x4;
	((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCON = 0x03;
