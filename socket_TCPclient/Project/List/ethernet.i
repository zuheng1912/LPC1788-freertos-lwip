...
#line 164 "..\\Lwip\\netif\\ethernet.c"
  ...
  switch (type) {
    ...
    case ((u16_t)((((ETHTYPE_IP) & (u16_t)0x00ffU) << 8) | (((ETHTYPE_IP) & (u16_t)0xff00U) >> 8))):
    ...
    case ((u16_t)((((ETHTYPE_ARP) & (u16_t)0x00ffU) << 8) | (((ETHTYPE_ARP) & (u16_t)0xff00U) >> 8))):
      if (!(netif->flags & 0x08U)) {
        goto free_and_return;
      }
...
#line 293 "..\\Lwip\\netif\\ethernet.c"
  ...
  do { if (!((netif->hwaddr_len == 6))) { do {printf("netif->hwaddr_len must be 6 for ethernet_output!");}while(0); }} while(0);
